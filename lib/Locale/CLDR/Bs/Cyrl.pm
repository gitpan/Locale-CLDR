...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AFA' => {
			display_name => {
				'default' => q(Авганистански авган (1927–2002)),
		...
		'AOR' => {
			display_name => {
				'default' => q(Анголска кванза реађустадо (1995–1999)),
		...
		'MRO' => {
			display_name => {
				'default' => q(Мауританијска угвија),
		...
		'PGK' => {
			display_name => {
				'default' => q(Папуа ново-гвинејшка кина),
		...
		'TJS' => {
			display_name => {
				'default' => q(Таљихистански сомони),
		...
		'XCD' => {
			display_name => {
				'default' => q(Источно-карибски долар),
