...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Apia' => {
			long => {
				'daylight' => q(Sommerzeit in Apia),
				'generic' => q(Zeit in Apia),
				'standard' => q(Normalzeit in Apia),
			},
		},
		'Aqtau' => {
			long => {
