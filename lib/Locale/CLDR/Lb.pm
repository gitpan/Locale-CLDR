...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(Britescht Pond Sterling),
				'one' => q(Britescht Pond Sterling),
				'other' => q(Britesch Pond Sterling),
			},
		},
		'GEK' => {
			display_name => {
