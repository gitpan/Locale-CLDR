...
has 'curriencies' => (
	...
	default		=> sub { {
		'ADP' => {
			display_name => {
				'default' => q(এ্যান্ডোরান পেসেতা),
			},
		},
		'AED' => {
			display_name => {
				'default' => q(সংযুক্ত আরব আমিরাত দিরহাম),
		...
		'ANG' => {
			display_name => {
				'default' => q(নেদারল্যান্ড এ্যান্টিলিয়ান গুল্ডের),
		...
		'AOA' => {
			display_name => {
				'default' => q(এ্যাঙ্গোলান কওয়ানজা),
		...
		'AOK' => {
			display_name => {
				'default' => q(এ্যাঙ্গোলান কওয়ানজা (১৯৭৭–১৯৯০)),
			},
		},
		'AON' => {
			display_name => {
				'default' => q(এ্যাঙ্গোলান নতুন কওয়ানজা (১৯৯৫–২০০০)),
			},
		},
		'AOR' => {
			display_name => {
				'default' => q(এ্যাঙ্গোলান কওয়ানজা (১৯৯৫–১৯৯৯)),
			},
		},
		'ARA' => {
			display_name => {
				'default' => q(আর্জেন্টিনা অস্ট্রাল),
			},
		},
		'ARP' => {
			display_name => {
				'default' => q(আর্জেন্টিনা পেসো (১৯৮৩–১৯৮৫)),
			},
		},
		'ARS' => {
			display_name => {
				'default' => q(আর্জেন্টিনা পেসো),
		...
		'ATS' => {
			display_name => {
				'default' => q(অস্ট্রিয়ান শিলিং),
			},
		},
		'AUD' => {
			symbol => 'A$',
			display_name => {
				'default' => q(অস্ট্রেলিয়ান ডলার),
		...
		'AZM' => {
			display_name => {
				'default' => q(আজারবাইজান মানাত (১৯৯৩–২০০৬)),
			},
		},
		'AZN' => {
			display_name => {
				'default' => q(আজারবাইজান মানাত),
		...
		'BAD' => {
			display_name => {
				'default' => q(বসনিয়া এবং হার্জেগোভিনা দিনার),
			},
		},
		'BAM' => {
			display_name => {
				'default' => q(বসনিয়া এবং হার্জেগোভিনা মার্ক),
		...
		'BEC' => {
			display_name => {
				'default' => q(বেলজিয়ান ফ্রাঙ্ক (রূপান্তরযোগ্য)),
			},
		},
		'BEF' => {
			display_name => {
				'default' => q(বেলজিয়ান ফ্রাঙ্ক),
			},
		},
		'BEL' => {
			display_name => {
				'default' => q(বেলজিয়ান ফ্রাঙ্ক (আর্থিক)),
			},
		},
		'BGL' => {
			display_name => {
				'default' => q(বুলগেরীয় হার্ড লেভ),
			},
		},
		'BGN' => {
			display_name => {
				'default' => q(বুলগেরীয় নিউ লেভ),
		...
		'BOP' => {
			display_name => {
				'default' => q(বলিভিয়ান পেসো),
			},
		},
		'BOV' => {
			display_name => {
				'default' => q(বলিভিয়ান মভডোল),
			},
		},
		'BRB' => {
			display_name => {
				'default' => q(ব্রাজিলিয়ান ক্রুজেয়রোনোভো (১৯৬৭–১৯৮৬)),
			},
		},
		'BRC' => {
			display_name => {
				'default' => q(ব্রাজিলিয়ান ক্রুজেইডাউ),
			},
		},
		'BRE' => {
			display_name => {
				'default' => q(ব্রাজিলিয়ান ক্রুজেয়রো (১৯৯০–১৯৯৩)),
			},
		},
		'BRL' => {
			symbol => 'R$',
			display_name => {
				'default' => q(ব্রাজিলিয়ান রিয়েল),
		...
		'BRN' => {
			display_name => {
				'default' => q(ব্রাজিলিয়ান ক্রুজেইডো নোভো),
			},
		},
		'BRR' => {
			display_name => {
				'default' => q(ব্রাজিলিয়ান ক্রুজেয়রো),
			},
		},
		'BSD' => {
			display_name => {
				'default' => q(বাহামিয়ান ডলার),
		...
		'BUK' => {
			display_name => {
				'default' => q(বর্মি কিয়াৎ),
			},
		},
		'BWP' => {
			display_name => {
				'default' => q(বতসোয়ানা পুলা),
		...
		'BYB' => {
			display_name => {
				'default' => q(বেলারুশিয়ান নিউ রুবেল (১৯৯৪–১৯৯৯)),
			},
		},
		'BYR' => {
			display_name => {
				'default' => q(বেলারুশিয়ান রুবেল),
		...
		'CDF' => {
			display_name => {
				'default' => q(কঙ্গো ফ্র্যাঙ্ক কঙ্গোলাইস),
		...
		'CHE' => {
			display_name => {
				'default' => q(সুইজারল্যান্ড ইউরো),
			},
		},
		'CHF' => {
			display_name => {
				'default' => q(সুইস ফ্রাঙ্ক),
				'one' => q(সুইস ফ্রাঙ্ক),
		...
		'CHW' => {
			display_name => {
				'default' => q(সুইজারল্যান্ড ফ্রাঙ্ক),
			},
		},
		'CLF' => {
			display_name => {
				'default' => q(চিলিয়ান উনিদাদেস দি ফোমেন্তো),
			},
		},
		'CLP' => {
			display_name => {
		...
		'CNY' => {
			symbol => 'CN¥',
			display_name => {
				'default' => q(চীনা য়ুয়ান রেন্মিন্‌বি),
		...
		'COU' => {
			display_name => {
				'default' => q(উনিদাদ দি ভ্যালোর রিয়েল),
			},
		},
		'CRC' => {
			display_name => {
				'default' => q(কোস্টা রিকা কোলোন),
		...
		'CSD' => {
			display_name => {
				'default' => q(প্রাচীন সারবিয়ান দিনার),
			},
		},
		'CSK' => {
			display_name => {
				'default' => q(চেকোস্লোভাক হার্ড কোরুনা),
			},
		},
		'CUC' => {
			display_name => {
				'default' => q(কিউবান রূপান্তরযোগ্য পেসো),
		...
		'CYP' => {
			display_name => {
				'default' => q(সাইপ্রাস পাউন্ড),
			},
		},
		'CZK' => {
			display_name => {
				'default' => q(চেকোস্লোভাক কোরুনা),
		...
		'DDM' => {
			display_name => {
				'default' => q(পূর্ব জার্মান মার্ক),
			},
		},
		'DEM' => {
			display_name => {
				'default' => q(ডয়চ্ মার্ক),
			},
		},
		'DJF' => {
			display_name => {
				'default' => q(জিবুতি ফ্রাঙ্ক),
		...
		'ECS' => {
			display_name => {
				'default' => q(ইকুয়াডোর সুক্রে),
			},
		},
		'ECV' => {
			display_name => {
				'default' => q(ইকুয়াডোর উনিদাদেস দি ভেলর কনসতান্তে (ইউভিসি)),
			},
		},
		'EEK' => {
			display_name => {
				'default' => q(এস্তোনিয়া ক্রুনি),
			},
		},
		'EGP' => {
			display_name => {
				'default' => q(মিশরীয় পাউন্ড),
		...
		'ESA' => {
			display_name => {
				'default' => q(স্প্যানিশ পেসেতা (একই হিসাব)),
			},
		},
		'ESB' => {
			display_name => {
				'default' => q(স্প্যানিশ পেসেতা (রূপান্তরযোগ্য হিসাব)),
			},
		},
		'ESP' => {
			display_name => {
				'default' => q(স্প্যানিশ পেসেতা),
			},
		},
		'ETB' => {
			display_name => {
				'default' => q(ইথিওপিয়ান বির),
		...
		'FKP' => {
			display_name => {
				'default' => q(ফকল্যান্ড দ্বীপপুঞ্জ পাউন্ড),
		...
		'FRF' => {
			display_name => {
				'default' => q(ফরাসি ফ্রাঙ্ক),
			},
		},
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(ব্রিটিশ পাউন্ড স্টার্লিং),
		...
		'GEK' => {
			display_name => {
				'default' => q(জর্জিয়ান কুপন লারিট),
			},
		},
		'GEL' => {
			display_name => {
				'default' => q(জর্জিয়ান লারি),
		...
		'GNS' => {
			display_name => {
				'default' => q(গিনি সাইলি),
			},
		},
		'GQE' => {
			display_name => {
				'default' => q(ইকুয়েটোরিয়াল গিনি ইকুয়িলি),
			},
		},
		'GRD' => {
			display_name => {
				'default' => q(গ্রীক দ্রাচমা),
			},
		},
		'GTQ' => {
			display_name => {
				'default' => q(গুয়াতেমালা কুয়েৎজাল),
		...
		'GWE' => {
			display_name => {
				'default' => q(পর্তুগিজ গিনি এসকুডো),
			},
		},
		'GWP' => {
			display_name => {
				'default' => q(গিনি বিসাউ পেসো),
			},
		},
		'GYD' => {
			display_name => {
				'default' => q(গাইয়েনা ডলার),
				'one' => q(গাইয়েনা ডলার),
		...
		'HRD' => {
			display_name => {
				'default' => q(ক্রোয়েশিয়ান দিনার),
			},
		},
		'HRK' => {
			display_name => {
				'default' => q(ক্রোয়েশিয়ান কুনা),
		...
		'HUF' => {
			display_name => {
				'default' => q(হাঙ্গেরিয়ান ফোরিন্ট),
		...
		'IDR' => {
			display_name => {
				'default' => q(ইন্দোনেশিয়ান রুপিয়াহ),
		...
		'IEP' => {
			display_name => {
				'default' => q(ইরিশ পাউন্ড),
			},
		},
		'ILP' => {
			display_name => {
				'default' => q(ইস্রাইলি পাউন্ড),
			},
		},
		'ILS' => {
			symbol => '₪',
			display_name => {
				'default' => q(ইস্রাইলি নতুন শেকেল),
		...
		'ITL' => {
			display_name => {
				'default' => q(ইতালীয় লিরা),
			},
		},
		'JMD' => {
			display_name => {
				'default' => q(জ্যামাইকান ডলার),
		...
		'KYD' => {
			display_name => {
				'default' => q(কেম্যান দ্বীপপুঞ্জের ডলার),
		...
		'LSL' => {
			display_name => {
				'default' => q(লেসুটু লোটি),
			},
		},
		'LTL' => {
			display_name => {
				'default' => q(লিথুইনিয়ান লিটা),
		...
		'LTT' => {
			display_name => {
				'default' => q(লিথুইনিয়ান টালোন্যাস),
			},
		},
		'LUC' => {
			display_name => {
				'default' => q(লুক্সেমবার্গ রুপান্তযোগ্য ফ্রাঙ্ক),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(লুক্সেমবার্গ ফ্রাঙ্ক),
			},
		},
		'LUL' => {
			display_name => {
				'default' => q(লুক্সেমবার্গ ফাইনেনশিয়াল ফ্রাঙ্ক),
			},
		},
		'LVL' => {
			display_name => {
				'default' => q(ল্যাটভিয়ান ল্যাট্‌স),
		...
		'LVR' => {
			display_name => {
				'default' => q(ল্যাটভিয়ান রুবল),
			},
		},
		'LYD' => {
			display_name => {
				'default' => q(লিবিয়ান ডলার),
				'one' => q(লিবিয়ান ডলার),
		...
		'MAF' => {
			display_name => {
				'default' => q(মোরোক্কান ফ্রাঙ্ক),
			},
		},
		'MDL' => {
			display_name => {
				'default' => q(মোল্ডোভান লেয়ু),
		...
		'MGA' => {
			display_name => {
				'default' => q(মাদাগাস্কার আরিয়ারি),
		...
		'MGF' => {
			display_name => {
				'default' => q(মাদাগাস্কার ফ্রাঙ্ক),
			},
		},
		'MKD' => {
			display_name => {
				'default' => q(ম্যাসেডোনিয়ান দিনার),
		...
		'MLF' => {
			display_name => {
				'default' => q(মালি ফ্রাঙ্ক),
			},
		},
		'MMK' => {
			display_name => {
				'default' => q(মায়ানমার কিয়াত),
		...
		'MRO' => {
			display_name => {
				'default' => q(মৌরিতানিয়ান ওউগুইয়া),
		...
		'MTL' => {
			display_name => {
				'default' => q(মাল্টা লিরা),
			},
		},
		'MTP' => {
			display_name => {
				'default' => q(মাল্টা পাউন্ড),
			},
		},
		'MUR' => {
			display_name => {
				'default' => q(মৌরিতানিয়ান রুপি),
		...
		'MXP' => {
			display_name => {
				'default' => q(ম্যাক্সিকান সিলভার পেসো (১৮৬১–১৯৯২)),
			},
		},
		'MXV' => {
			display_name => {
				'default' => q(মেক্সিকান উনিদাদ দি ইনভার্সান (UDI)),
			},
		},
		'MYR' => {
			display_name => {
				'default' => q(মালয়েশিয়ান রিঙ্গিৎ),
		...
		'MZE' => {
			display_name => {
				'default' => q(মোজাম্বিক এসকুডো),
			},
		},
		'MZM' => {
			display_name => {
				'default' => q(প্রাচীন মোজাম্বিক মেটিকেল),
			},
		},
		'MZN' => {
			display_name => {
				'default' => q(মোজাম্বিক মেটিকেল),
		...
		'NIC' => {
			display_name => {
				'default' => q(নিকারাগুয়ান কর্ডোবা (১৯৮৮–১৯৯১)),
			},
		},
		'NIO' => {
			display_name => {
				'default' => q(নিকারাগুয়ান কর্ডোবা),
		...
		'NLG' => {
			display_name => {
				'default' => q(নেদারল্যান্ড গুল্ডের),
			},
		},
		'NOK' => {
			display_name => {
				'default' => q(নরওয়ে ক্রৌন),
				'one' => q(নরওয়ে ক্রৌন),
		...
		'PEI' => {
			display_name => {
				'default' => q(পেরুভিয়ান ইন্তি),
			},
		},
		'PEN' => {
			display_name => {
				'default' => q(পেরুভিয়ান সোল নুয়েভো),
		...
		'PES' => {
			display_name => {
				'default' => q(পেরুভিয়ান সোল),
			},
		},
		'PGK' => {
			display_name => {
				'default' => q(পপুয়ানিউগিনি কিনা),
		...
		'PLZ' => {
			display_name => {
				'default' => q(পোলিশ জ্লোটি (১৯৫০–১৯৯৫)),
			},
		},
		'PTE' => {
			display_name => {
				'default' => q(পর্তুগিজ এসকুডো),
			},
		},
		'PYG' => {
			display_name => {
				'default' => q(প্যারগুয়ান),
				'one' => q(প্যারগুয়ান),
				'other' => q(প্যারগুয়ান),
			},
		},
		...
		'RHD' => {
			display_name => {
				'default' => q(রোডেশিয়ান ডলার),
			},
		},
		'ROL' => {
			display_name => {
				'default' => q(প্রাচীন রুমানিয়া লেয়ু),
			},
		},
		'RON' => {
			display_name => {
				'default' => q(রুমানিয়া লেয়ু),
		...
		'RUR' => {
			display_name => {
				'default' => q(রাশিয়ান রুবল (১৯৯১–১৯৯৮)),
			},
		},
		'RWF' => {
			display_name => {
				'default' => q(রুয়ান্ডান ফ্রাঙ্ক),
		...
		'SBD' => {
			display_name => {
				'default' => q(সলোমন দ্বীপপুঞ্জ ডলার),
		...
		'SDD' => {
			display_name => {
				'default' => q(প্রাচীন সুদানি দিনার),
			},
		},
		'SDG' => {
			display_name => {
				'default' => q(সুদানি পাউন্ড),
				'one' => q(সুদানি পাউন্ড),
		...
		'SDP' => {
			display_name => {
				'default' => q(প্রাচীন সুদানি পাউন্ড),
			},
		},
		'SEK' => {
			display_name => {
				'default' => q(সুইডিশ ক্রোনা),
				'one' => q(সুইডিশ ক্রোনা),
		...
		'SIT' => {
			display_name => {
				'default' => q(স্লোভানিয়া টোলার),
			},
		},
		'SKK' => {
			display_name => {
				'default' => q(স্লোভাক কোরুনা),
			},
		},
		'SLL' => {
			display_name => {
				'default' => q(সিয়েরালিয়ন লিয়ন),
		...
		'SRG' => {
			display_name => {
				'default' => q(সুরিনাম গিল্ডার),
			},
		},
		'SSP' => {
			display_name => {
				'default' => q(দক্ষিণ সুদানি পাউন্ড),
		...
		'STD' => {
			display_name => {
				'default' => q(সাও টোমে এবং প্রিন্সিপে ডোবরা),
		...
		'SUR' => {
			display_name => {
				'default' => q(সোভিয়েত রুবল),
			},
		},
		'SVC' => {
			display_name => {
				'default' => q(এল স্যালভোডোর কোলোন),
			},
		},
		'SYP' => {
			display_name => {
				'default' => q(সিরিয়ান পাউন্ড),
		...
		'SZL' => {
			display_name => {
				'default' => q(সোয়াজিল্যান্ড লিলাঙ্গেনি),
		...
		'TJR' => {
			display_name => {
				'default' => q(তাজিকিস্তান রুবল),
			},
		},
		'TJS' => {
			display_name => {
				'default' => q(তাজিকিস্তান সোমোনি),
		...
		'TMM' => {
			display_name => {
				'default' => q(তুর্কমেনিস্টানি মানাত),
			},
		},
		'TMT' => {
			display_name => {
				'default' => q(তুর্কমেনিস্তান নতুন মানত),
		...
		'TPE' => {
			display_name => {
				'default' => q(তিমুর এসকুডো),
			},
		},
		'TRL' => {
			display_name => {
				'default' => q(প্রাচীন তুর্কি লিরা),
			},
		},
		'TRY' => {
			display_name => {
				'default' => q(তুর্কি লিরা),
				'one' => q(তুর্কি লিরা),
				'other' => q(তুর্কি লিরা),
			},
		},
		'TTD' => {
			display_name => {
				'default' => q(ত্রিনিদাদ এবং টোবাগো ডলার),
		...
		'TWD' => {
			symbol => 'NT$',
			display_name => {
				'default' => q(নূতন তাইওয়ান ক্যারাবিয়ান ডলার),
		...
		'UAK' => {
			display_name => {
				'default' => q(ইউক্রেইন কার্বোভ্যান্টস),
			},
		},
		'UGS' => {
			display_name => {
				'default' => q(উগান্ডান শিলিং (১৯৬৬–১৯৮৭)),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(উগান্ডান শিলিং),
		...
		'USN' => {
			display_name => {
				'default' => q(মার্কিন ডলার (পরবর্তী দিন)),
			},
		},
		'USS' => {
			display_name => {
				'default' => q(মার্কিন ডলার (একই দিন)),
			},
		},
		'UYI' => {
			display_name => {
				'default' => q(উরুগুয়ায়ান পেসো এন উনিদাদেস ইনডেক্সেডাস),
			},
		},
		'UYP' => {
			display_name => {
				'default' => q(উরুগুয়ে পেসো (১৯৭৫–১৯৯৩)),
			},
		},
		'UYU' => {
			display_name => {
				'default' => q(উরুগুয়ে পেসো),
		...
		'VEB' => {
			display_name => {
				'default' => q(ভেনিজুয়েলান বলিভার (১৮৭১–২০০৮)),
			},
		},
		'VEF' => {
			display_name => {
				'default' => q(ভেনিজুয়েলীয় বলিভার),
		...
		'WST' => {
			display_name => {
				'default' => q(পশ্চিমাঞ্চলীয় সামোয়ান টালা),
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'default' => q(সিএফএ ফ্র্যাঙ্ক বিইএসি),
		...
		'XBB' => {
			display_name => {
				'default' => q(ইউরোপীয় আর্থিক একক),
			},
		},
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(পূর্ব ক্যারাবিয়ান ডলার),
		...
		'XEU' => {
			display_name => {
				'default' => q(ইউরোপীয় মুদ্রা একক),
			},
		},
		'XFO' => {
			display_name => {
				'default' => q(ফরাসি গোল্ড ফ্রাঙ্ক),
			},
		},
		'XFU' => {
			display_name => {
				'default' => q(ফরাসি ইউআইসি - ফ্রাঙ্ক),
			},
		},
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q(সিএফএ ফ্র্যাঙ্ক বিসিইএও),
		...
		'XPD' => {
			display_name => {
				'default' => q(প্যালেডিয়াম),
			},
		},
		'XPF' => {
			symbol => 'CFPF',
			display_name => {
				'default' => q(সিএফপি ফ্র্যাঙ্ক),
		...
		'YDD' => {
			display_name => {
				'default' => q(ইয়েমেনি দিনার),
			},
		},
		'YER' => {
			display_name => {
				'default' => q(ইয়েমেনি রিয়াল),
		...
		'YUD' => {
			display_name => {
				'default' => q(যুগোশ্লাভিয় হার্ড দিনার),
			},
		},
		'YUM' => {
			display_name => {
				'default' => q(যুগোশ্লাভিয় নোভি দিনার),
			},
		},
		'YUN' => {
			display_name => {
				'default' => q(যুগোশ্লাভিয় রুপান্তরযোগ্য দিনার),
			},
		},
		'ZAL' => {
			display_name => {
				'default' => q(দক্ষিণ আফ্রিকান র‌্যান্ড),
			},
		},
		'ZAR' => {
			display_name => {
				'default' => q(দক্ষিণ আফ্রিকান রেন্ড),
		...
		'ZMK' => {
			display_name => {
				'default' => q(জাম্বিয়ান কওয়াচা (১৯৬৮–২০১২)),
			},
		},
		'ZMW' => {
			display_name => {
				'default' => q(জাম্বিয়ান কওয়াচা),
		...
		'ZRN' => {
			display_name => {
				'default' => q(জাইরিয়ান নিউ জাইরে),
			},
		},
		'ZRZ' => {
			display_name => {
				'default' => q(জাইরিয়ান জাইরে),
			},
		},
		'ZWD' => {
			display_name => {
				'default' => q(জিম্বাবুয়ে ডলার (১৯৮০–২০০৮)),
			},
		},
		'ZWL' => {
			display_name => {
				'default' => q(জিম্বাবুয়ে ডলার (২০০৯)),
			},
		},
		'ZWR' => {
			display_name => {
				'default' => q(জিম্বাবুয়ে ডলার (২০০৮)),
			},
		},
	} },
);
