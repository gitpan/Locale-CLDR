...
has 'calendar_quarters' => (
	...
	default		=> sub { {
			'gregorian' => {
				'format' => {
					abbreviated => {0 => 'প্র. ত্রৈ. এক. চতুর্থাংশ',
						1 => 'দ্বি.ত্রৈ.এক. চতুর্থাংশ',
						2 => 'তৃ.ত্রৈ.এক.চতুর্থাংশ',
						3 => 'চ.ত্রৈ.এক চতুর্থাংশ'
					},
					narrow => {0 => '১',
						1 => '২',
						2 => '৩',
					...
					wide => {0 => 'প্রথম ত্রৈমাসিকের এক চতুর্থাংশ',
						1 => 'দ্বিতীয় ত্রৈমাসিকের এক চতুর্থাংশ',
						2 => 'তৃতীয় ত্রৈমাসিকের এক চতুর্থাংশ',
						3 => 'চতুর্থ ত্রৈমাসিকের এক চতুর্থাংশ'
					},
				},
				'stand-alone' => {
					abbreviated => {0 => 'প্র.ত্রৈ.এক.চতুর্থাংশ',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'America_Central' => {
			long => {
				'daylight' => q(উত্তর আমেরিকার মধ্যবর্তী অঞ্চলের দিনের সময়),
				'generic' => q(উত্তর আমেরিকার মধ্যবর্তী অঞ্চলের সময়),
				'standard' => q(উত্তর আমেরিকার মধ্যবর্তী অঞ্চলের প্রমাণ সময়),
			},
		},
		'America_Eastern' => {
			long => {
				'daylight' => q(উত্তর আমেরিকার পূর্বাঞ্চলের দিনের সময়),
				'generic' => q(উত্তর আমেরিকার পূর্বাঞ্চলীয় সময়),
				'standard' => q(উত্তর আমেরিকার পূর্বাঞ্চলের প্রমাণ সময়),
			},
		},
		'America_Mountain' => {
			long => {
				'daylight' => q(উত্তর আমেরিকার পার্বত্য অঞ্চলের দিনের সময়),
				'generic' => q(উত্তর আমেরিকার পার্বত্য অঞ্চলের সময়),
				'standard' => q(উত্তর আমেরিকার পার্বত্য অঞ্চলের প্রমাণ সময়),
			},
		},
		'America_Pacific' => {
			long => {
				'daylight' => q(উত্তর আমেরিকার প্রশান্ত মহাসাগরীয় অঞ্চলের দিনের সময়),
				'generic' => q(উত্তর আমেরিকার প্রশান্ত মহাসাগরীয় অঞ্চলের সময়),
				'standard' => q(উত্তর আমেরিকার প্রশান্ত মহাসাগরীয় অঞ্চলের প্রমাণ সময়),
			},
		},
		'Anadyr' => {
			long => {
