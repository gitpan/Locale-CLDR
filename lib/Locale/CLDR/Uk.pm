...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'currency' => q(західноафриканський франк BCEAO),
