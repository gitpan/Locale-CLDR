...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AFA' => {
			display_name => {
				'default' => q(афгані (1927–2002)),
			},
		},
		'AFN' => {
			display_name => {
				'default' => q(афганський афгані),
		...
		'ANG' => {
			display_name => {
				'default' => q(нідерландський антильський гульден),
		...
		'AOK' => {
			display_name => {
				'default' => q(ангольська кванза (1977–1990)),
		...
		'AON' => {
			display_name => {
				'default' => q(ангольська нова кванза (1990–2000)),
		...
		'AOR' => {
			display_name => {
				'default' => q(ангольська кванза реаджастадо (1995–1999)),
		...
		'ARA' => {
			display_name => {
				'default' => q(аргентинський австрал),
		...
		'ARP' => {
			display_name => {
				'default' => q(аргентинський песо (1983–1985)),
			},
		},
		'ARS' => {
			display_name => {
				'default' => q(аргентинський песо),
		...
		'ATS' => {
			display_name => {
				'default' => q(австрійський шилінг),
			},
		},
		'AUD' => {
			symbol => 'AU$',
			display_name => {
				'default' => q(австралійський долар),
		...
		'AZM' => {
			display_name => {
				'default' => q(азербайджанський манат (1993–2006)),
		...
		'AZN' => {
			symbol => 'ман.',
			display_name => {
				'default' => q(азербайджанський манат),
		...
		'BAD' => {
			display_name => {
				'default' => q(динар (Боснія і Герцеговина)),
			},
		},
		'BAM' => {
			display_name => {
				'default' => q(конвертована марка Боснії і Герцеговини),
		...
		'BEC' => {
			display_name => {
				'default' => q(бельгійський франк (конвертований)),
			},
		},
		'BEF' => {
			display_name => {
				'default' => q(бельгійський франк),
			},
		},
		'BEL' => {
			display_name => {
				'default' => q(бельгійський франк (фінансовий)),
			},
		},
		'BGL' => {
			display_name => {
				'default' => q(болгарський твердий лев),
			},
		},
		'BGN' => {
			display_name => {
				'default' => q(болгарський лев),
		...
		'BOB' => {
			display_name => {
				'default' => q(болівійський болівіано),
		...
		'BOP' => {
			display_name => {
				'default' => q(болівійське песо),
			},
		},
		'BOV' => {
			display_name => {
				'default' => q(болівійський мвдол),
			},
		},
		'BRB' => {
			display_name => {
				'default' => q(бразильське нове крузейро (1967–1986)),
			},
		},
		'BRC' => {
			display_name => {
				'default' => q(бразильське крузадо),
			},
		},
		'BRE' => {
			display_name => {
				'default' => q(бразильське крузейро (1990–1993)),
			},
		},
		'BRL' => {
			symbol => 'BRL',
			display_name => {
				'default' => q(бразильський реал),
		...
		'BRN' => {
			display_name => {
				'default' => q(бразильське нове крузадо),
			},
		},
		'BRR' => {
			display_name => {
				'default' => q(бразильське крузейро),
			},
		},
		'BSD' => {
			display_name => {
				'default' => q(багамський долар),
		...
		'BUK' => {
			display_name => {
				'default' => q(бірманський кіат),
			},
		},
		'BWP' => {
			display_name => {
				'default' => q(ботсванська пула),
		...
		'BYB' => {
			display_name => {
				'default' => q(білоруський новий рубль (1994–1999)),
		...
		'CLF' => {
			display_name => {
				'default' => q(чилійський юнідадес де фоменто),
			},
		},
		'CLP' => {
			display_name => {
				'default' => q(чилійський песо),
		...
		'COU' => {
			display_name => {
				'default' => q(одиниця реальної вартості),
			},
		},
		'CRC' => {
			display_name => {
				'default' => q(костариканський колон),
		...
		'CSD' => {
			display_name => {
				'default' => q(старий сербський динар),
			},
		},
		'CSK' => {
			display_name => {
				'default' => q(чехословацька тверда крона),
			},
		},
		'CUC' => {
			display_name => {
				'default' => q(кубинський конвертований песо),
		...
		'CYP' => {
			display_name => {
				'default' => q(кіпрський фунт),
			},
		},
		'CZK' => {
			display_name => {
				'default' => q(чеська крона),
				'few' => q(чеські крони),
				'many' => q(чеських крон),
				'one' => q(чеська крона),
		...
		'DEM' => {
			display_name => {
				'default' => q(німецька марка),
			},
		},
		'DJF' => {
			display_name => {
				'default' => q(джибутійський франк),
		...
		'ECS' => {
			display_name => {
				'default' => q(еквадорський сукре),
			},
		},
		'ECV' => {
			display_name => {
				'default' => q(еквадорський юнідад де валор константе),
			},
		},
		'EEK' => {
			display_name => {
				'default' => q(естонська крона),
		...
		'ESA' => {
			display_name => {
				'default' => q(іспанська песета ("А" рахунок)),
			},
		},
		'ESB' => {
			display_name => {
				'default' => q(іспанська песета (конвертовані рахунки)),
			},
		},
		'ESP' => {
			display_name => {
				'default' => q(іспанська песета),
			},
		},
		'ETB' => {
			display_name => {
				'default' => q(ефіопський бир),
		...
		'FIM' => {
			display_name => {
				'default' => q(фінляндська марка),
			},
		},
		'FJD' => {
			display_name => {
				'default' => q(фіджійський долар),
		...
		'FKP' => {
			display_name => {
				'default' => q(фунт Фолклендських островів),
		...
		'FRF' => {
			display_name => {
				'default' => q(французький франк),
			},
		},
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(англійський фунт стерлінгів),
		...
		'GHC' => {
			display_name => {
				'default' => q(ганський седі (1979–2007)),
			},
		},
		'GHS' => {
			display_name => {
				'default' => q(ганський седі),
				'few' => q(ганські седі),
		...
		'GNS' => {
			display_name => {
				'default' => q(гвінейське сілі),
			},
		},
		'GQE' => {
			display_name => {
				'default' => q(еквеле (Екваторіальна Ґвінея)),
			},
		},
		'GRD' => {
			display_name => {
				'default' => q(грецька драхма),
			},
		},
		'GTQ' => {
			display_name => {
				'default' => q(гватемальський кетсаль),
		...
		'GWE' => {
			display_name => {
				'default' => q(ескудо португальської гвінеї),
			},
		},
		'GWP' => {
			display_name => {
				'default' => q(песо Гвінеї-Бісау),
			},
		},
		'GYD' => {
			display_name => {
				'default' => q(гаянський долар),
		...
		'HRD' => {
			display_name => {
				'default' => q(хорватський динар),
			},
		},
		'HRK' => {
			display_name => {
				'default' => q(хорватська куна),
		...
		'IEP' => {
			display_name => {
				'default' => q(ірландський фунт),
			},
		},
		'ILP' => {
			display_name => {
				'default' => q(ізраїльський фунт),
			},
		},
		'ILS' => {
			symbol => 'ILS',
			display_name => {
				'default' => q(ізраїльський новий шекель),
		...
		'ITL' => {
			display_name => {
				'default' => q(італійська ліра),
			},
		},
		'JMD' => {
			display_name => {
				'default' => q(ямайський долар),
		...
		'KHR' => {
			display_name => {
				'default' => q(камбоджійський рієль),
		...
		'KPW' => {
			display_name => {
				'default' => q(північнокорейський вон),
		...
		'KRW' => {
			symbol => 'KRW',
			display_name => {
				'default' => q(південнокорейський вон),
		...
		'KYD' => {
			display_name => {
				'default' => q(долар Кайманових островів),
		...
		'KZT' => {
			display_name => {
				'default' => q(казахстанський тенге),
		...
		'LKR' => {
			display_name => {
				'default' => q(шрі-ланкійська рупія),
		...
		'LSL' => {
			display_name => {
				'default' => q(лесотський лоті),
			},
		},
		'LTL' => {
			display_name => {
				'default' => q(литовський літ),
		...
		'LTT' => {
			display_name => {
				'default' => q(литовський талон),
			},
		},
		'LUC' => {
			display_name => {
				'default' => q(люксембурґський франк (конвертований)),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(люксембурзький франк),
			},
		},
		'LUL' => {
			display_name => {
				'default' => q(люксембурґський франк (фінансовий)),
			},
		},
		'LVL' => {
			display_name => {
				'default' => q(латвійський лат),
		...
		'LVR' => {
			display_name => {
				'default' => q(латвійський рубль),
			},
		},
		'LYD' => {
			display_name => {
				'default' => q(лівійський динар),
		...
		'MAD' => {
			display_name => {
				'default' => q(марокканський дирхам),
		...
		'MAF' => {
			display_name => {
				'default' => q(марокканський франк),
			},
		},
		'MDL' => {
			display_name => {
				'default' => q(молдовський лей),
		...
		'MGA' => {
			display_name => {
				'default' => q(малагасійський аріарі),
		...
		'MGF' => {
			display_name => {
				'default' => q(мадагаскарський франк),
			},
		},
		'MKD' => {
			display_name => {
				'default' => q(македонський денар),
		...
		'MLF' => {
			display_name => {
				'default' => q(малійський франк),
			},
		},
		'MMK' => {
			display_name => {
				'default' => q(кʼят Мʼянми),
				'few' => q(кʼяти Мʼянми),
		...
		'MTL' => {
			display_name => {
				'default' => q(мальтійська ліра),
			},
		},
		'MTP' => {
			display_name => {
				'default' => q(мальтійський фунт),
			},
		},
		'MUR' => {
			display_name => {
				'default' => q(маврикійська рупія),
		...
		'MXP' => {
			display_name => {
				'default' => q(мексиканське срібне песо (1861–1992)),
			},
		},
		'MXV' => {
			display_name => {
				'default' => q(мексиканський юнідад де інверсіон),
			},
		},
		'MYR' => {
			display_name => {
				'default' => q(малайзійський рингіт),
		...
		'MZE' => {
			display_name => {
				'default' => q(мозамбіцький ескудо),
			},
		},
		'MZM' => {
			display_name => {
				'default' => q(старий мозамбіцький метикал),
			},
		},
		'MZN' => {
			display_name => {
				'default' => q(мозамбіцький метикал),
		...
		'NIC' => {
			display_name => {
				'default' => q(нікарагуанська кордоба),
			},
		},
		'NIO' => {
			display_name => {
				'default' => q(нікарагуанська кордоба оро),
		...
		'NLG' => {
			display_name => {
				'default' => q(нідерландський гульден),
			},
		},
		'NOK' => {
			display_name => {
				'default' => q(норвезька крона),
		...
		'NZD' => {
			symbol => 'NZD',
			display_name => {
				'default' => q(новозеландський долар),
		...
		'PEI' => {
			display_name => {
				'default' => q(перуанський інті),
			},
		},
		'PEN' => {
			display_name => {
				'default' => q(перуанський новий сол),
		...
		'PES' => {
			display_name => {
				'default' => q(перуанський сол),
			},
		},
		'PGK' => {
			display_name => {
				'default' => q(кіна Папуа Нової Гвінеї),
		...
		'PLZ' => {
			display_name => {
				'default' => q(польський злотий (1950–1995)),
			},
		},
		'PTE' => {
			display_name => {
				'default' => q(португальський ескудо),
			},
		},
		'PYG' => {
			display_name => {
				'default' => q(парагвайський гуарані),
		...
		'RHD' => {
			display_name => {
				'default' => q(родезійський долар),
			},
		},
		'ROL' => {
			display_name => {
				'default' => q(старий румунський лей),
			},
		},
		'RON' => {
			display_name => {
				'default' => q(румунський лей),
				'few' => q(румунські леї),
		...
		'RUR' => {
			display_name => {
				'default' => q(російський рубль (1991–1998)),
		...
		'SBD' => {
			display_name => {
				'default' => q(долар Соломонових Островів),
		...
		'SDD' => {
			display_name => {
				'default' => q(суданський динар),
			},
		},
		'SDG' => {
			display_name => {
				'default' => q(суданський фунт),
		...
		'SDP' => {
			display_name => {
				'default' => q(старий суданський фунт),
			},
		},
		'SEK' => {
			display_name => {
				'default' => q(шведська крона),
		...
		'SHP' => {
			display_name => {
				'default' => q(фунт острова Святої Єлени),
		...
		'SIT' => {
			display_name => {
				'default' => q(словенський толар),
			},
		},
		'SKK' => {
			display_name => {
				'default' => q(словацька крона),
		...
		'SRG' => {
			display_name => {
				'default' => q(суринамський гульден),
			},
		},
		'SSP' => {
			display_name => {
				'default' => q(південносуданський фунт),
		...
		'STD' => {
			display_name => {
				'default' => q(добра Сан-Томе і Принсіпі),
		...
		'SVC' => {
			display_name => {
				'default' => q(сальвадорський колон),
			},
		},
		'SYP' => {
			display_name => {
				'default' => q(сирійський фунт),
		...
		'SZL' => {
			display_name => {
				'default' => q(свазілендський лілангені),
		...
		'TJR' => {
			display_name => {
				'default' => q(таджицький рубль),
			},
		},
		'TJS' => {
			display_name => {
				'default' => q(таджицький сомоні),
		...
		'TMM' => {
			display_name => {
				'default' => q(туркменський манат (1993–2009)),
		...
		'TPE' => {
			display_name => {
				'default' => q(тіморський ескудо),
			},
		},
		'TRL' => {
			display_name => {
				'default' => q(турецька ліра (1922–2005)),
		...
		'TTD' => {
			display_name => {
				'default' => q(долар Тринідаду і Тобаго),
		...
		'TWD' => {
			symbol => 'TWD',
			display_name => {
				'default' => q(новий тайванський долар),
		...
		'TZS' => {
			display_name => {
				'default' => q(танзанійський шилінганзанійський шилінг),
		...
		'UAK' => {
			symbol => 'крб.',
			display_name => {
				'default' => q(український карбованець),
		...
		'UGS' => {
			display_name => {
				'default' => q(угандійський шилінг (1966–1987)),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(угандійський шилінг),
		...
		'USN' => {
			display_name => {
				'default' => q(долар США (наступного дня)),
			},
		},
		'USS' => {
			display_name => {
				'default' => q(долар США (цього дня)),
			},
		},
		'UYI' => {
			display_name => {
				'default' => q(уругвайський песо в індексованих одиницях),
			},
		},
		'UYP' => {
			display_name => {
				'default' => q(уругвайське песо (1975–1993)),
			},
		},
		'UYU' => {
			display_name => {
				'default' => q(уругвайський песо),
		...
		'VEB' => {
			display_name => {
				'default' => q(венесуельський болівар (1871–2008)),
			},
		},
		'VEF' => {
			display_name => {
				'default' => q(венесуельський болівар),
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'default' => q(центральноафриканський франк),
		...
		'XBA' => {
			display_name => {
				'default' => q(європейська складена валютна одиниця),
			},
		},
		'XBB' => {
			display_name => {
				'default' => q(одиниця європейського валютного фонду),
			},
		},
		'XBC' => {
			display_name => {
				'default' => q(європейська розрахункова одиниця XBC),
			},
		},
		'XBD' => {
			display_name => {
				'default' => q(європейська розрахункова одиниця XBD),
			},
		},
		'XCD' => {
			symbol => 'XCD',
			display_name => {
				'default' => q(східнокарибський долар),
		...
		'XDR' => {
			display_name => {
				'default' => q(спеціальні права запозичення),
				'few' => q(СПЗ),
				'many' => q(СПЗ),
				'one' => q(СПЗ),
				'other' => q(СПЗ),
		...
		'XEU' => {
			display_name => {
				'default' => q(європейська валютна одиниця),
			},
		},
		'XFO' => {
			display_name => {
				'default' => q(французький золотий франк),
			},
		},
		'XFU' => {
			display_name => {
				'default' => q(французький франк UIC),
			},
		},
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q(західноафриканський франк),
		...
		'XPF' => {
			symbol => 'CFPF',
			display_name => {
				'default' => q(французький тихоокеанський франк),
		...
		'XRE' => {
			display_name => {
				'default' => q(фонди RINET),
			},
		},
		'XTS' => {
			display_name => {
				'default' => q(код тестування валюти),
			},
		},
		'XXX' => {
			display_name => {
				'default' => q(невідома грошова одиниця),
		...
		'YDD' => {
			display_name => {
				'default' => q(єменський динар),
			},
		},
		'YER' => {
			display_name => {
				'default' => q(єменський ріал),
		...
		'YUD' => {
			display_name => {
				'default' => q(югославський твердий динар),
			},
		},
		'YUM' => {
			display_name => {
				'default' => q(югославський новий динар),
			},
		},
		'YUN' => {
			display_name => {
				'default' => q(югославський конвертований динар),
			},
		},
		'ZAL' => {
			display_name => {
				'default' => q(південноафриканський фінансовий ранд),
			},
		},
		'ZAR' => {
			display_name => {
				'default' => q(південноафриканський ранд),
		...
		'ZMK' => {
			display_name => {
				'default' => q(замбійська квача (1968–2012)),
		...
		'ZRN' => {
			display_name => {
				'default' => q(заїрський новий заїр),
			},
		},
		'ZRZ' => {
			display_name => {
				'default' => q(заїрський заїр),
			},
		},
		'ZWD' => {
			display_name => {
				'default' => q(зімбабвійський долар),
		...
		'ZWL' => {
			display_name => {
				'default' => q(зімбабвійський долар (2009)),
