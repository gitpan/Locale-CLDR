...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'kilometer-per-hour' => {
						'' => q(kilometeri per nalunaaquttap-akunnera),
					...
					'mile-per-hour' => {
						'' => q(engelske mil per nalunaaquttap-akunnera),
