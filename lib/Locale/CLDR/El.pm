...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'g-force' => {
						'' => q(ατμοσφαιρική επιτάχυνση βαρύτητας),
					...
					'second' => {
						'' => q({0} ανά δευτερόλεπτο),
						'one' => q({0} δευτερόλεπτο),
						'other' => q({0} δευτερόλεπτα),
					},
					'square-centimeter' => {
						'' => q(τετραγωνικά εκατοστά),
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'America/Lower_Princes' => {
			exemplarCity => q#Lower Prince’s Quarter (Άγιος Μαρτίνος Ολλανδίας)#,
		},
		'America/Maceio' => {
