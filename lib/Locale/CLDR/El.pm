...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AED' => {
			display_name => {
				'default' => q(Ντιράμ Ηνωμένων Αραβικών Εμιράτων),
		...
		'AFA' => {
			display_name => {
				'default' => q(Αφγανί Αφγανιστάν (1927–2002)),
		...
		'ANG' => {
			display_name => {
				'default' => q(Γκίλντα Ολλανδικών Αντιλλών),
		...
		'AOK' => {
			display_name => {
				'default' => q(Κουάνζα Ανγκόλας (1977–1990)),
		...
		'AON' => {
			display_name => {
				'default' => q(Νέα Κουάνζα Ανγκόλας (1990–2000)),
		...
		'ARP' => {
			display_name => {
				'default' => q(Πέσο Αργεντινής (1983–1985)),
		...
		'AZM' => {
			display_name => {
				'default' => q(Μανάτ Αζερμπαϊτζάν (1993–2006)),
		...
		'BAD' => {
			display_name => {
				'default' => q(Δηνάριο Βοσνίας-Ερζεγοβίνης),
		...
		'BAM' => {
			display_name => {
				'default' => q(Μετατρέψιμο Μάρκο Βοσνίας-Ερζεγοβίνης),
		...
		'BEC' => {
			display_name => {
				'default' => q(Φράγκο Βελγίου (μετατρέψιμο)),
		...
		'BEL' => {
			display_name => {
				'default' => q(Φράγκο Βελγίου (οικονομικό)),
		...
		'BGL' => {
			display_name => {
				'default' => q(Μεταλλικό Λεβ Βουλγαρίας),
		...
		'BRB' => {
			display_name => {
				'default' => q(Νέο Κρουζιέρο Βραζιλίας (1967–1986)),
		...
		'BRE' => {
			display_name => {
				'default' => q(Κρουζιέρο Βραζιλίας (1990–1993)),
		...
		'BRN' => {
			display_name => {
				'default' => q(Νέο Κρουζάντο Βραζιλίας),
		...
		'BYB' => {
			display_name => {
				'default' => q(Νέο Ρούβλι Λευκορωσίας (1994–1999)),
		...
		'CLF' => {
			display_name => {
				'default' => q(Ουνιδάδες ντε φομέντο Χιλής),
		...
		'CSD' => {
			display_name => {
				'default' => q(Παλαιό Δηνάριο Σερβίας),
		...
		'CSK' => {
			display_name => {
				'default' => q(Σκληρή Κορόνα Τσεχοσλοβακίας),
		...
		'CUC' => {
			display_name => {
				'default' => q(Μετατρέψιμο πέσο Κούβας),
		...
		'CVE' => {
			display_name => {
				'default' => q(Εσκούδο Πράσινου Ακρωτηρίου),
		...
		'DDM' => {
			display_name => {
				'default' => q(Οστμάρκ Ανατολικής Γερμανίας),
		...
		'DOP' => {
			display_name => {
				'default' => q(Πέσο Δομινικανής Δημοκρατίας),
		...
		'ESA' => {
			display_name => {
				'default' => q(πεσέτα Ισπανίας (λογαριασμός Α)),
		...
		'ESB' => {
			display_name => {
				'default' => q(πεσέτα Ισπανίας (μετατρέψιμος λογαριασμός)),
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(Λίρα Στερλίνα Βρετανίας),
		...
		'GEK' => {
			display_name => {
				'default' => q(Κούπον Λάρι Γεωργίας),
		...
		'GHC' => {
			display_name => {
				'default' => q(Σέντι Γκάνας (1979–2007)),
		...
		'GQE' => {
			display_name => {
				'default' => q(Εκγουέλε Ισημερινής Γουινέας),
		...
		'GTQ' => {
			display_name => {
				'default' => q(Κουετσάλ Γουατεμάλας),
		...
		'GWE' => {
			display_name => {
				'default' => q(Γκινέα Εσκούδο Πορτογαλίας),
		...
		'GWP' => {
			display_name => {
				'default' => q(Πέσο Γουινέας-Μπισάου),
		...
		'ISJ' => {
			display_name => {
				'default' => q(Παλιά κορόνα Ισλανδίας),
		...
		'KPW' => {
			display_name => {
				'default' => q(Γουόν Βόρειας Κορέας),
		...
		'KYD' => {
			display_name => {
				'default' => q(Δολάριο Νήσων Κάιμαν),
		...
		'LUC' => {
			display_name => {
				'default' => q(Μετατρέψιμο Φράγκο Λουξεμβούργου),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(Φράγκο Λουξεμβούργου),
		...
		'LUL' => {
			display_name => {
				'default' => q(Οικονομικό Φράγκο Λουξεμβούργου),
			},
		},
		'LVL' => {
			display_name => {
				'default' => q(Λατς Λετονίας),
				'one' => q(λατς Λετονίας),
		...
		'MRO' => {
			display_name => {
				'default' => q(Ουγκίγια Μαυριτανίας),
		...
		'MXP' => {
			display_name => {
				'default' => q(Ασημένιο Πέσο Μεξικού (1861–1992)),
		...
		'MZM' => {
			display_name => {
				'default' => q(Παλαιό Μετικάλ Μοζαμβίκης),
		...
		'NIO' => {
			display_name => {
				'default' => q(Χρυσή Κόρδοβα Νικαράγουας),
		...
		'NZD' => {
			symbol => 'NZ$',
			display_name => {
				'default' => q(Δολάριο Νέας Ζηλανδίας),
		...
		'PGK' => {
			display_name => {
				'default' => q(Κίνα Παπούα Νέα Γουινέα),
		...
		'PLZ' => {
			display_name => {
				'default' => q(Ζλότυ Πολωνίας (1950–1995)),
		...
		'PYG' => {
			display_name => {
				'default' => q(Γκουαρανί Παραγουάης),
		...
		'RUR' => {
			display_name => {
				'default' => q(Ρούβλι Ρωσίας (1991–1998)),
		...
		'SAR' => {
			display_name => {
				'default' => q(Ριάλ Σαουδικής Αραβίας),
		...
		'SBD' => {
			display_name => {
				'default' => q(Δολάριο Νήσων Σολομώντος),
		...
		'STD' => {
			display_name => {
				'default' => q(Ντόμπρα Σάο Τομέ και Πρίνσιπε),
		...
		'SZL' => {
			display_name => {
				'default' => q(Λιλανγκένι Σουαζιλάνδης),
		...
		'TTD' => {
			display_name => {
				'default' => q(Δολάριο Τρινιντάντ και Τομπάγκο),
		...
		'UAK' => {
			display_name => {
				'default' => q(Καρμποβανέτς Ουκρανίας),
		...
		'UGS' => {
			display_name => {
				'default' => q(Σελίνι Ουγκάντας (1966–1987)),
		...
		'USN' => {
			display_name => {
				'default' => q(Δολάριο ΗΠΑ (επόμενη ημέρα)),
		...
		'USS' => {
			display_name => {
				'default' => q(Δολάριο ΗΠΑ (ίδια ημέρα)),
		...
		'UYP' => {
			display_name => {
				'default' => q(Πέσο Ουρουγουάης (1975–1993)),
		...
		'VEB' => {
			display_name => {
				'default' => q(Μπολιβάρ Βενεζουέλας (1871–2008)),
		...
		'VEF' => {
			display_name => {
				'default' => q(Μπολιβάρ Βενεζουέλας),
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'default' => q(Φράγκο CFA Κεντρικής Αφρικής),
		...
		'XBA' => {
			display_name => {
				'default' => q(Ευρωπαϊκή Σύνθετη Μονάδα),
		...
		'XBB' => {
			display_name => {
				'default' => q(Ευρωπαϊκή Νομισματική Μονάδα),
		...
		'XBC' => {
			display_name => {
				'default' => q(Ευρωπαϊκή μονάδα λογαριασμού (XBC)),
		...
		'XBD' => {
			display_name => {
				'default' => q(Ευρωπαϊκή μονάδα λογαριασμού (XBD)),
		...
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(Δολάριο Ανατολικής Καραϊβικής),
		...
		'XDR' => {
			display_name => {
				'default' => q(Ειδικά Δικαιώματα Ανάληψης),
		...
		'XEU' => {
			display_name => {
				'default' => q(Ευρωπαϊκή Συναλλαγματική Μονάδα),
		...
		'XFO' => {
			display_name => {
				'default' => q(Χρυσό Φράγκο Γαλλίας),
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q(Φράγκο CFA Δυτικής Αφρικής),
		...
		'YUD' => {
			display_name => {
				'default' => q(Μεταλλικό Δηνάριο Γιουγκοσλαβίας),
		...
		'YUM' => {
			display_name => {
				'default' => q(Νέο Δηνάριο Γιουγκοσλαβίας),
		...
		'YUN' => {
			display_name => {
				'default' => q(Μετατρέψιμο Δηνάριο Γιουγκοσλαβίας),
		...
		'ZAL' => {
			display_name => {
				'default' => q(Ραντ Νότιας Αφρικής (οικονομικό)),
		...
		'ZMK' => {
			display_name => {
				'default' => q(Κουάνζα Ζαΐρ (1968–2012)),
		...
		'ZWL' => {
			display_name => {
				'default' => q(Δολάριο Ζιμπάμπουε (2009)),
