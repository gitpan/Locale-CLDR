...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AED' => {
			display_name => {
				'default' => q(Обединети Арапски Емирати Дирхам),
		...
		'ANG' => {
			display_name => {
				'default' => q(Холандски антилски гилдер),
		...
		'AOK' => {
			display_name => {
				'default' => q(Анголска Кванза (1977–1990)),
			},
		},
		'AON' => {
			display_name => {
				'default' => q(Анголска нова Кванза (1990–2000)),
			},
		},
		'ARP' => {
			display_name => {
				'default' => q(Аргентински Пезос (1983–1985)),
			},
		},
		'ARS' => {
			display_name => {
				'default' => q(Аргентински Пезос),
		...
		'ATS' => {
			display_name => {
				'default' => q(Австралиски Шилинг),
			},
		},
		'AUD' => {
			symbol => 'AUD',
			display_name => {
				'default' => q(Австралиски долар),
		...
		'BAD' => {
			display_name => {
				'default' => q(Босанско-Херцеговски Динар),
			},
		},
		'BAM' => {
			display_name => {
				'default' => q(Босанско-Херцеговска конвертибилна марка),
		...
		'BEC' => {
			display_name => {
				'default' => q(Белгиски Франк (конвертибилен)),
			},
		},
		'BEF' => {
			display_name => {
				'default' => q(Белгиски Франк),
			},
		},
		'BEL' => {
			display_name => {
				'default' => q(Белгиски Франк (финансиски)),
			},
		},
		'BGL' => {
			display_name => {
				'default' => q(Бугарски цврст лев),
			},
		},
		'BGN' => {
			display_name => {
		...
		'CSK' => {
			display_name => {
				'default' => q(Чехословачка цврста корона),
			},
		},
		'CUC' => {
			display_name => {
				'default' => q(Кубански пезос (конвертибилен)),
		...
		'FRF' => {
			display_name => {
				'default' => q(Француски франк),
			},
		},
		'GBP' => {
			symbol => 'GBP',
			display_name => {
				'default' => q(Британска Фунта),
		...
		'GHC' => {
			display_name => {
				'default' => q(Ганајски Седи),
			},
		},
		'GHS' => {
			display_name => {
				'default' => q(Гански седи),
				'one' => q(Гански седи),
				'other' => q(Гански седи),
			},
		},
		...
		'GWP' => {
			display_name => {
				'default' => q(Гвинејски Бисау пезос),
			},
		},
		'GYD' => {
			display_name => {
				'default' => q(Гвијански Долар),
		...
		'KPW' => {
			display_name => {
				'default' => q(Северно корејски вон),
		...
		'KYD' => {
			display_name => {
				'default' => q(Долар на кајмански острови),
		...
		'LTT' => {
			display_name => {
				'default' => q(Литваниски литаз),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(Луксембуршки франк),
			},
		},
		'LVL' => {
			display_name => {
				'default' => q(Латвијски лат),
				'one' => q(Латвијски лат),
		...
		'MXP' => {
			display_name => {
				'default' => q(Мексикански сребрен пезос (1861–1992)),
			},
		},
		'MYR' => {
			display_name => {
				'default' => q(Малазиски рингит),
		...
		'MZE' => {
			display_name => {
				'default' => q(Мозамбиско ескудо),
			},
		},
		'MZM' => {
			display_name => {
				'default' => q(Стар мозамбиски метикал),
			},
		},
		'MZN' => {
			display_name => {
				'default' => q(Мозамбиски метикал),
		...
		'NIC' => {
			display_name => {
				'default' => q(Никарагванска кордоба (1988–1991)),
		...
		'PGK' => {
			display_name => {
				'default' => q(Папуа новогвинејска кина),
		...
		'ROL' => {
			display_name => {
				'default' => q(Романска леи (1952–2006)),
		...
		'SHP' => {
			display_name => {
				'default' => q(Фунта на Света Елена),
		...
		'STD' => {
			display_name => {
				'default' => q(Добра на Сао Томе и Принсипе),
		...
		'SZL' => {
			display_name => {
				'default' => q(Свазилендски лиланген),
		...
		'TJR' => {
			display_name => {
				'default' => q(Таџикистанска рубља),
			},
		},
		'TJS' => {
			display_name => {
				'default' => q(Таџикистански сомони),
		...
		'UGS' => {
			display_name => {
				'default' => q(Угандиски шилинг (1966–1987)),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(Угандиски шилинг),
		...
		'USN' => {
			display_name => {
				'default' => q(САД долар (Next day)),
			},
		},
		'USS' => {
			display_name => {
				'default' => q(САД долар (Same day)),
			},
		},
		'UYP' => {
			display_name => {
				'default' => q(Уругвајски пезос (1975–1993)),
			},
		},
		'UYU' => {
			display_name => {
				'default' => q(Уругвајски пезос),
		...
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(Источно карибиски долар),
		...
		'YUD' => {
			display_name => {
				'default' => q(Југословенски динар),
			},
		},
		'YUN' => {
			display_name => {
				'default' => q(Југословенски конвертибилен динар),
			},
		},
		'ZAL' => {
			display_name => {
				'default' => q(Јужно афрички ранд(финансиски)),
			},
		},
		'ZAR' => {
			display_name => {
		...
		'ZRN' => {
			display_name => {
				'default' => q(Заирско новозаире),
			},
		},
		'ZRZ' => {
			display_name => {
				'default' => q(Заирско заире),
			},
		},
		'ZWD' => {
			display_name => {
				'default' => q(Зимбабвиски долар),
			},
		},
	} },
);
