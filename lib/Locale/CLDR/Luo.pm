...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'BWP' => {
			display_name => {
				'default' => q(Pula mar Botswana),
			},
		},
		'CAD' => {
			display_name => {
				'default' => q(Dola mar Kanada),
			},
		},
		'CDF' => {
			display_name => {
		...
		'GBP' => {
			display_name => {
				'default' => q(Pauni mar Uingereza),
			},
		},
		'GHC' => {
			display_name => {
				'default' => q(Sedi mar Ghana),
			},
		},
		'GMD' => {
			display_name => {
		...
		'JPY' => {
			display_name => {
				'default' => q(Yen mar Japan),
			},
		},
		'KES' => {
			symbol => 'Ksh',
			display_name => {
				'default' => q(Siling mar Kenya),
			},
		},
		'KMF' => {
			display_name => {
