...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'ANG' => {
			display_name => {
				'default' => q(നെതർലൻഡ്സ് ആൻറിലൻ ഗിൽഡർ),
		...
		'AOK' => {
			display_name => {
				'default' => q(അംഗോളൻ ‍ക്വാൻസ (1977–1990)),
		...
		'AON' => {
			display_name => {
				'default' => q(അംഗോളൻ ‍ന്യൂ ക്വാൻസ (1990–2000)),
		...
		'AOR' => {
			display_name => {
				'default' => q(അംഗോളൻ ‍ക്വാൻസ റിയാജസ്റ്റാഡോ (1995–1999)),
		...
		'ARP' => {
			display_name => {
				'default' => q(അർജൻറീൻ പെയ്സോ (1983–1985)),
		...
		'ATS' => {
			display_name => {
				'default' => q(ഓസ്ട്രേലിയൻ ഷില്ലിംഗ്),
		...
		'AZM' => {
			display_name => {
				'default' => q(അസർബയ്ജാനിയൻ മനത് (1993–2006)),
		...
		'BAD' => {
			display_name => {
				'default' => q(ബോസ്നിയ-ഹെർസഗോവിന ദിനാർ),
		...
		'BAM' => {
			display_name => {
				'default' => q(ബോസ്നിയ-ഹെർസഗോവിന കൺവേർട്ടിബിൾ മാർക്ക്),
		...
		'BEC' => {
			display_name => {
				'default' => q(ബെൽജിയൻ ഫ്രാങ്ക് (കൈമാറ്റം ചെയ്യാവുന്നത്)),
		...
		'BRB' => {
			display_name => {
				'default' => q(ബ്രസീലിയൻ ക്രുസെയ്റോ നോവോ (1967–1986)),
		...
		'BRE' => {
			display_name => {
				'default' => q(ബ്രസീലിയൻ ക്രുസെയ്റോ (1990–1993)),
		...
		'BRN' => {
			display_name => {
				'default' => q(ബ്രസീലിയൻ ക്രുസാഡോ നോവോ),
		...
		'BRR' => {
			display_name => {
				'default' => q(ബ്രസീലിയൻ ക്രുസെയ്റോ),
		...
		'BYB' => {
			display_name => {
				'default' => q(ബെലാറഷ്യൻ ന്യൂ റൂബിൾ (1994–1999)),
		...
		'CLF' => {
			display_name => {
				'default' => q(ചിലിയൻ യൂണിഡാഡ്സ് ഡി ഫോമെൻറോ),
		...
		'COU' => {
			display_name => {
				'default' => q(യൂണിഡാഡ് ഡി വാലർ റിയൽ),
		...
		'CRC' => {
			display_name => {
				'default' => q(കോസ്റ്റാ റിക്കൻ കോളൻ),
		...
		'CSD' => {
			display_name => {
				'default' => q(പ്രാചീന സെർബിയൻ ദിനാർ),
		...
		'CSK' => {
			display_name => {
				'default' => q(ചെക്കോസ്ലൊവാക്ക് ഹാർഡ് കൊരൂന),
		...
		'CUC' => {
			display_name => {
				'default' => q(ക്യൂബൻ പരിവർത്തിത പെസോ),
		...
		'CVE' => {
			display_name => {
				'default' => q(കെയ്പ് വെർഡെ എസ്ക്യുഡോ),
		...
		'CZK' => {
			display_name => {
				'default' => q(ചെക്ക് റിപ്പബ്ലിക് കൊരൂന),
		...
		'DDM' => {
			display_name => {
				'default' => q(കിഴക്കൻ ജർമൻ ഓസ്റ്റ്മാർക്ക്),
		...
		'ECV' => {
			display_name => {
				'default' => q(ഇക്വഡോർ യൂണിഡാഡ് വാലർ കോൺസ്റ്റൻറെ (UVC)),
		...
		'ESA' => {
			display_name => {
				'default' => q(സ്പാനിഷ് പസെയ്റ്റ (A അക്കൌണ്ട്)),
		...
		'ESB' => {
			display_name => {
				'default' => q(സ്പാനിഷ് പസെയ്റ്റ (കൈമാറ്റം ചെയ്യാവുന്ന അക്കൌണ്ട്)),
		...
		'FKP' => {
			display_name => {
				'default' => q(ഫോക്‌ലാൻഡ് ദ്വീപുകളുടെ പൌണ്ട്),
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(ബ്രിട്ടീഷ് പൌണ്ട് സ്റ്റെർലിംങ്),
		...
		'GEK' => {
			display_name => {
				'default' => q(ജോർ‍ജ്ജിയൻ ക്യൂപോൺ ലാരിറ്റ്),
		...
		'GQE' => {
			display_name => {
				'default' => q(ഇക്വിറ്റോറിയൽ ഗിനിയ എക്വീലെ ഗിനിയാന),
		...
		'GTQ' => {
			display_name => {
				'default' => q(ഗ്വാട്ടിമാല ക്വെറ്റ്സൽ),
		...
		'GWE' => {
			display_name => {
				'default' => q(പോർച്ചുഗീസ് ഗിനി എസ്ക്യൂഡോ),
		...
		'KYD' => {
			display_name => {
				'default' => q(കെയ്മൻദ്വീപുകളുടെ ഡോളർ‌),
		...
		'LUC' => {
			display_name => {
				'default' => q(ലക്സംബർഗ് കൺവേർട്ടിബിൾ ഫ്രാങ്ക്),
		...
		'LUL' => {
			display_name => {
				'default' => q(ലക്സംബർഗ് ഫിനാൻഷ്യൽ ഫ്രാങ്ക്),
		...
		'LYD' => {
			display_name => {
				'default' => q(ലിബിയൻ ദിനാർ),
			},
		},
		'MAD' => {
			display_name => {
				'default' => q(മൊറോക്കൻ ദിർഹം),
			},
		},
		'MAF' => {
			display_name => {
				'default' => q(മൊറോക്കൻ ഫ്രാങ്ക്),
			},
		},
		'MDL' => {
			display_name => {
				'default' => q(മൊൽഡോവൻ ലിയൂ),
			},
		},
		'MGA' => {
			display_name => {
				'default' => q(മഡഗാസ്കർ ഏരിയറി),
			},
		},
		'MGF' => {
			display_name => {
				'default' => q(മഡഗാസ്കർ ഫ്രാങ്ക്),
			},
		},
		'MKD' => {
			display_name => {
				'default' => q(മാസിഡോണിയൻ ദിനാർ),
			},
		},
		'MLF' => {
			display_name => {
				'default' => q(മാലി ഫ്രാങ്ക്),
			},
		},
		'MMK' => {
			display_name => {
				'default' => q(മ്യാൻമാർ ചാറ്റ്),
		...
		'MNT' => {
			display_name => {
				'default' => q(മംഗോളിയൻ തുഗ്രിക്),
			},
		},
		'MOP' => {
			display_name => {
				'default' => q(മക്കാനീസ് പതാക്ക),
		...
		'MTL' => {
			display_name => {
				'default' => q(മൽത്തീസ് ലിറ),
			},
		},
		'MTP' => {
			display_name => {
				'default' => q(മൽത്തീസ് പൌണ്ട്),
			},
		},
		'MUR' => {
			display_name => {
				'default' => q(മൌറീഷ്യൻ രൂപ),
				'one' => q(മൌറീഷ്യൻ രൂപ),
		...
		'MXP' => {
			display_name => {
				'default' => q(മെക്സിക്കൻ സിൽവർ പെയ്സോ (1861–1992)),
		...
		'MXV' => {
			display_name => {
				'default' => q(മെക്സിക്കൻ യൂണിഡാഡ് ഡി ഇൻവെർഷൻ (UDI)),
		...
		'MYR' => {
			display_name => {
				'default' => q(മലേഷ്യൻ റിംഗിറ്റ്),
			},
		},
		'MZE' => {
			display_name => {
				'default' => q(മൊസാന്പിക്ക് എസ്ക്യുഡോ),
			},
		},
		'MZM' => {
			display_name => {
				'default' => q(ഓൾഡ് മൊസാന്പിക്ക് മെറ്റിക്കൽ),
			},
		},
		'MZN' => {
			display_name => {
				'default' => q(മൊസാമ്പിക്ക് മെറ്റിക്കൽ),
			},
		},
		'NAD' => {
			display_name => {
				'default' => q(നമീബിയൻ ഡോളർ),
			},
		},
		'NGN' => {
			display_name => {
				'default' => q(നൈജീരിയൻ നൈറ),
			},
		},
		'NIC' => {
			display_name => {
				'default' => q(നികരാഗ്വൻ കൊർഡോബ),
			},
		},
		'NIO' => {
			display_name => {
				'default' => q(നികരാഗ്വൻ കൊർഡോബ ഒരോ),
			},
		},
		'NLG' => {
			display_name => {
				'default' => q(നെതർലൻഡ്സ് ഗിൽഡർ),
		...
		'NPR' => {
			display_name => {
				'default' => q(നേപ്പാളി രൂപ),
			},
		},
		'NZD' => {
			symbol => 'NZ$',
			display_name => {
				'default' => q(ന്യൂസിലാൻഡ് ഡോളർ),
		...
		'OMR' => {
			display_name => {
				'default' => q(ഒമാൻ റിയാൽ),
			},
		},
		'PAB' => {
			display_name => {
				'default' => q(പനാമെയ്നിയൻ ബാൽബോവ),
		...
		'PGK' => {
			display_name => {
				'default' => q(പാപുവ ന്യൂ ഗിനിയൻ കിന),
		...
		'PLZ' => {
			display_name => {
				'default' => q(പോളിഷ് സ്ലോട്ടി (1950–1995)),
			},
		},
		'PTE' => {
			display_name => {
				'default' => q(പോർച്ചുഗീസ് എസ്ക്യുഡോ),
			},
		},
		'PYG' => {
			display_name => {
				'default' => q(പരാഗ്വേയൻ ഗ്വരനീ),
		...
		'QAR' => {
			display_name => {
				'default' => q(ഖത്തർ റിയാൽ),
			},
		},
		'RHD' => {
			display_name => {
				'default' => q(റൊഡേഷ്യൻ ഡോളർ),
			},
		},
		'ROL' => {
			display_name => {
				'default' => q(പ്രാചീന റൊമേനിയൻ ലിയു),
			},
		},
		'RON' => {
			display_name => {
				'default' => q(റൊമേനിയൻ ലിയു),
			},
		},
		'RSD' => {
			display_name => {
				'default' => q(സെർബിയൻ ദിനാർ),
			},
		},
		'RUB' => {
			display_name => {
				'default' => q(റഷ്യൻ റൂബിൾ),
				'one' => q(റഷ്യൻ റൂബിൾ),
		...
		'RUR' => {
			display_name => {
				'default' => q(റഷ്യൻ റൂബിൾ (1991–1998)),
			},
		},
		'RWF' => {
			display_name => {
				'default' => q(റുവാണ്ടൻ ഫ്രാങ്ക്),
			},
		},
		'SAR' => {
			display_name => {
				'default' => q(സൌദി റിയാൽ),
			},
		},
		'SBD' => {
			display_name => {
				'default' => q(സോളമൻ ദ്വീപുകളുടെ ഡോളർ),
			},
		},
		'SCR' => {
			display_name => {
				'default' => q(സെയ്ഷെൽസ് രൂപ),
			},
		},
		'SDD' => {
			display_name => {
				'default' => q(പ്രാചീന സുഡാനീസ് ദിനാർ),
			},
		},
		'SDG' => {
			display_name => {
				'default' => q(സുഡാനീസ് പൌണ്ട്),
			},
		},
		'SDP' => {
			display_name => {
				'default' => q(പ്രാചീന സുഡാനീസ് പൌണ്ട്),
			},
		},
		'SEK' => {
			display_name => {
				'default' => q(സ്വീഡിഷ് ക്രോണ),
			},
		},
		'SGD' => {
			display_name => {
				'default' => q(സിംഗപ്പൂർ ഡോളർ),
			},
		},
		'SHP' => {
			display_name => {
				'default' => q(സെയ്ൻറ് ഹെലെന പൌണ്ട്),
			},
		},
		'SIT' => {
			display_name => {
				'default' => q(സ്ലൊവേനിയ റ്റോളർ),
			},
		},
		'SKK' => {
			display_name => {
				'default' => q(സ്ലോവാക് കൊരൂന),
			},
		},
		'SLL' => {
			display_name => {
				'default' => q(സിയറാ ലിയോൺ ലിയോൺ),
			},
		},
		'SOS' => {
			display_name => {
				'default' => q(സൊമാലി ഷില്ലിംഗ്),
			},
		},
		'SRD' => {
			display_name => {
				'default' => q(സൂരിനാം ഡോളർ),
			},
		},
		'SRG' => {
			display_name => {
				'default' => q(സൂരിനാം ഗിൽഡർ),
			},
		},
		'SSP' => {
			display_name => {
				'default' => q(ദക്ഷിണ സുഡാനീസ് പൗണ്ട്),
		...
		'STD' => {
			display_name => {
				'default' => q(സാവോ റ്റോമി ആൻഡ് പ്രിൻസിപ്പി ഡോബ്ര),
			},
		},
		'SUR' => {
			display_name => {
				'default' => q(സോവിയറ്റ് റൂബിൾ),
			},
		},
		'SVC' => {
			display_name => {
				'default' => q(എൽ സാൽവഡോർ കോളൻ),
			},
		},
		'SYP' => {
			display_name => {
				'default' => q(സിറിയൻ പൌണ്ട്),
				'one' => q(സിറിയൻ പൌണ്ട്),
		...
		'SZL' => {
			display_name => {
				'default' => q(സ്വാസിലാൻഡ് ലിലാംഗനി),
			},
		},
		'THB' => {
			symbol => '฿',
			display_name => {
				'default' => q(തായ് ബാത്ത്),
				'one' => q(തായ് ബാത്ത്),
				'other' => q(തായ് ബാത്ത്),
			},
		},
		...
		'TJS' => {
			display_name => {
				'default' => q(താജിക്കിസ്ഥാൻ സൊമോനി),
		...
		'TMT' => {
			display_name => {
				'default' => q(തുർക്കമനിസ്ഥാനി മനാത്ത്),
		...
		'TND' => {
			display_name => {
				'default' => q(തുനീസിയൻ ദിനാർ),
			},
		},
		'TOP' => {
			display_name => {
				'default' => q(റ്റോംഗൻ പാംഗ),
				'one' => q(റ്റോംഗൻ പാംഗ),
		...
		'TRL' => {
			display_name => {
				'default' => q(പ്രാചീന തുർക്കിഷ് ലിറ),
		...
		'TTD' => {
			display_name => {
				'default' => q(ട്രിനിഡാഡ് ആൻഡ് റ്റൊബാഗോ ഡോളർ),
			},
		},
		'TWD' => {
			symbol => 'NT$',
			display_name => {
				'default' => q(തായ്‌വാൻ ഡോളർ),
				'one' => q(തായ്‌വാൻ ഡോളർ),
		...
		'TZS' => {
			display_name => {
				'default' => q(ടാൻസാനിയൻ ഷില്ലിംഗ്),
			},
		},
		'UAH' => {
			display_name => {
				'default' => q(യുക്രേനിയൻ ഹ്രിവ്നിയ),
		...
		'UAK' => {
			display_name => {
				'default' => q(യുക്രേനിയൻ കാർബോവാനെസ്),
		...
		'UGS' => {
			display_name => {
				'default' => q(ഉഗാണ്ടൻ ഷില്ലിംഗ് (1966–1987)),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(ഉഗാണ്ടൻ ഷില്ലിംഗ്),
			},
		},
		'USD' => {
			symbol => '$',
			display_name => {
				'default' => q(യു.എസ്. ഡോളർ),
				'one' => q(യു.എസ് ഡോളർ),
				'other' => q(യു.എസ് ഡോളർ),
			},
		},
		'USN' => {
			display_name => {
				'default' => q(യുഎസ് ഡോളർ (അടുത്ത ദിവസം)),
			},
		},
		'USS' => {
			display_name => {
				'default' => q(യുഎസ് ഡോളർ (അതേ ദിവസം)),
		...
		'UYI' => {
			display_name => {
				'default' => q(ഉറുഗ്വേ പെയ്സോ എൻ യൂണിഡാഡ്സ്),
		...
		'UYP' => {
			display_name => {
				'default' => q(ഉറുഗ്വേ പെയ്സോ (1975–1993)),
		...
		'VEB' => {
			display_name => {
				'default' => q(വെനസ്വേലൻ ബോലിവർ (1871–2008)),
		...
		'VND' => {
			symbol => '₫',
			display_name => {
				'default' => q(വിയറ്റ്നാമീസ് ഡോങ്),
			},
		},
		'VUV' => {
			display_name => {
				'default' => q(വനുവാതു വാതു),
				'one' => q(വനുവാതു വാതു),
		...
		'XBA' => {
			display_name => {
				'default' => q(യൂറോപ്യൻ കോന്പസിറ്റ് യൂണിറ്റ്),
		...
		'XBB' => {
			display_name => {
				'default' => q(യൂറോപ്യൻ മോണിറ്ററി യൂണിറ്റ്),
		...
		'XBC' => {
			display_name => {
				'default' => q(യൂറോപ്യൻ യൂണിറ്റ് ഓഫ് അക്കൌണ്ട് (XBC)),
		...
		'XBD' => {
			display_name => {
				'default' => q(യൂറോപ്യൻ യൂണിറ്റ് ഓഫ് അക്കൌണ്ട് (XBD)),
		...
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(കിഴക്കൻ കരീബിയൻ ഡോളർ),
		...
		'XDR' => {
			display_name => {
				'default' => q(സ്പെഷ്യൽ ഡ്രോയിംഗ് റൈറ്റ്സ്),
		...
		'XEU' => {
			display_name => {
				'default' => q(യൂറോപ്യൻ നാണയ യൂണിറ്റ്),
		...
		'XFO' => {
			display_name => {
				'default' => q(ഫ്രെഞ്ച് ഗോൾഡ് ഫ്രാങ്ക്),
		...
		'XFU' => {
			display_name => {
				'default' => q(ഫ്രെഞ്ച് UIC-ഫ്രാങ്ക്),
		...
		'XTS' => {
			display_name => {
				'default' => q(ടെസ്റ്റിംഗിനുള്ള കറൻസി കോഡ്),
		...
		'YUD' => {
			display_name => {
				'default' => q(യൂഗോസ്ലേവിയൻ ഹാർഡ് ദിനാർ),
		...
		'YUM' => {
			display_name => {
				'default' => q(യൂഗോസ്ലേവിയൻ നോവി ദിനാർ),
		...
		'YUN' => {
			display_name => {
				'default' => q(യൂഗോസ്ലേവിയൻ കൺവേർട്ടിബിൾ ദിനാർ),
		...
		'ZAL' => {
			display_name => {
				'default' => q(ദക്ഷിണാഫ്രിക്കൻ റാൻഡ് (ഫിനാൻഷ്യൽ)),
		...
		'ZAR' => {
			display_name => {
				'default' => q(ദക്ഷിണ ആഫ്രിക്കൻ റാൻഡ്),
		...
		'ZMK' => {
			display_name => {
				'default' => q(സാംബിയൻ ക്വാച (1968–2012)),
