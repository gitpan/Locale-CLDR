...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്),
				'one' => q(ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്),
				'other' => q(ബ്രിട്ടീഷ് പൗണ്ട് സ്‌റ്റെർലിംഗ്),
			},
		},
		'GEK' => {
			display_name => {
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'America_Central' => {
			long => {
				'daylight' => q(വടക്കെ അമേരിക്കൻ സെൻട്രൽ പകൽ സമയം),
		...
		'America_Mountain' => {
			long => {
				'daylight' => q(വടക്കെ അമേരിക്കൻ മൌണ്ടൻ പകൽ സമയം),
		...
		'America_Pacific' => {
			long => {
				'daylight' => q(വടക്കെ അമേരിക്കൻ പസഫിക് പകൽ സമയം),
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(ഇനിയും-കിഴക്കൻ യൂറോപ്യൻ സമയം),
			},
		},
		'Europe_Western' => {
			long => {
		...
		'Mexico_Pacific' => {
			long => {
				...
				'standard' => q(മെക്സിക്കൻ പസഫിക് സാധാരണ സമയം),
			},
		},
		'Mongolia' => {
			long => {
		...
		'Newfoundland' => {
			long => {
				'daylight' => q(ന്യൂഫൗണ്ട്ലാൻഡ് ഡേലൈറ്റ് സമയം),
				'generic' => q(ന്യൂഫൗണ്ട്ലാൻഡ് സമയം),
				'standard' => q(ന്യൂഫൗണ്ട്ലാൻഡ് സ്റ്റാൻഡേർഡ് സമയം),
			},
		},
		'Niue' => {
			long => {
