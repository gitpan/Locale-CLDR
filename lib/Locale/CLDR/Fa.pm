	...
	default		=> sub { {
		...
		'XAF' => {
			...
			display_name => {
				...
				'one' => q(فرانک CFA مرکز آفریقا),
				'other' => q(فرانک CFA مرکز آفریقا),
			},
		},
		'XAG' => {
			display_name => {
		...
		'XOF' => {
			...
			display_name => {
				...
				'one' => q(فرانک CFA غرب آفریقا),
				'other' => q(فرانک CFA غرب آفریقا),
			},
		},
		'XPD' => {
			display_name => {
