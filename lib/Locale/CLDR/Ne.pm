		 ...
		 sub {
			 my %languages = (
				'ab' => 'अब्खाजियाली',
 				...
 				'el' => 'ग्रीक',
 				'en' => 'अंग्रेजी',
 				'en_US@alt=short' => 'अंग्रेजी (अमेरिका)',
 				'eo' => 'एस्पेरान्तो',
 				'es' => 'स्पेनिस',
