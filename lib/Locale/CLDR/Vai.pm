...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'CHF' => {
			display_name => {
				'default' => q(ꖬꔃꕤ ꖨꕮꕊ ꖢꕟꘋꕃ),
			},
		},
		'CNY' => {
			display_name => {
				'default' => q(ꕦꕇꔧ ꖳꕎꘋ ꔓꕆꘋꔬ),
			},
		},
		'CVE' => {
			display_name => {
				'default' => q(ꗡꔻꖴꖁ ꕪꕷꗲꗡꔵꕩꖆ),
			},
		},
		'DJF' => {
			display_name => {
		...
		'ZAR' => {
			display_name => {
				'default' => q(ꕉꔱꔸꕪ ꗛꔤ ꔒꘋꗣ ꗏ ꕟꘋꔵ),
			},
		},
		'ZMK' => {
			display_name => {
				'default' => q(ꕤꔭꕩ ꖴꕎꕦ (1968–2012)),
			},
		},
		'ZMW' => {
			display_name => {
