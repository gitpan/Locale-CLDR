...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ),
				'one' => q(ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ),
				'other' => q(ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ ਸਟਰਲਿੰਗ),
			},
		},
		'GEL' => {
			symbol => 'GEL',
