...
has 'curriencies' => (
	...
	default		=> sub { {
		'AED' => {
			display_name => {
				'default' => q(Dirham ya Falme cia Kiarabu),
			},
		},
		'AOA' => {
			display_name => {
		...
		'AUD' => {
			display_name => {
				'default' => q(Dola ya Austrĩlia),
			},
		},
		'BHD' => {
			display_name => {
				'default' => q(Dinari ya Baharini),
			},
		},
		'BIF' => {
			display_name => {
		...
		'CHF' => {
			display_name => {
				'default' => q(Faranga ya Swisilandi),
			},
		},
		'CNY' => {
			display_name => {
		...
		'DZD' => {
			display_name => {
				'default' => q(Dinari ya Anjĩria),
			},
		},
		'EGP' => {
			display_name => {
				'default' => q(Paũndi ya Misri),
			},
		},
		'ERN' => {
			display_name => {
		...
		'MGA' => {
			display_name => {
				'default' => q(Ariarĩ ya Bukini),
			},
		},
		'MRO' => {
			display_name => {
				'default' => q(Ugwiya ya Mauritania),
			},
		},
		'MUR' => {
			display_name => {
				'default' => q(Rupia ya Maurĩtiasi),
			},
		},
		'MWK' => {
			display_name => {
		...
		'MZM' => {
			display_name => {
				'default' => q(Metikali ya Mozambĩkĩ),
			},
		},
		'NAD' => {
			display_name => {
		...
		'SAR' => {
			display_name => {
				'default' => q(Riyal ya Saudi Arĩbia),
			},
		},
		'SCR' => {
			display_name => {
		...
		'SDG' => {
			display_name => {
				'default' => q(Paũndi ya Sudani),
			},
		},
		'SHP' => {
			display_name => {
				'default' => q(Paũndi ya Santahelena),
			},
		},
		'SLL' => {
			display_name => {
		...
		'ZAR' => {
			display_name => {
				'default' => q(Randi ya Afrika ya Sauthi),
			},
		},
		'ZMK' => {
			display_name => {
