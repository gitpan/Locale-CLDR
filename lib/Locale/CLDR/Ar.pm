	...
	default		=> sub { {
				'long' => {
					...
					'cubic-foot' => {
						...
						'one' => q({0} قدم مكعبة),
						'other' => q({0} من الأقدام المكعبة),
						'two' => q(قدمان مكعبان),
						'zero' => q({0} من الأقدام المكعبة),
					},
					'cubic-inch' => {
						'' => q(بوصة مكعبة),
						'few' => q({0} بوصة مكعبة),
					...
					'fluid-ounce' => {
						...
						'one' => q({0} أونصة سائلة),
						'other' => q({0} من الأونصات السائلة),
						'two' => q(أونصتان سائلتان),
						'zero' => q({0} من الأونصات السائلة),
					},
					'foodcalorie' => {
						'' => q(كالوري),
						'few' => q({0} كالوري),
					...
					'gallon' => {
						...
						'many' => q({0} غالونًا),
						'one' => q({0} غالون),
						'other' => q({0} من الغالونات),
						'two' => q(غالونان),
						'zero' => q({0} من الغالونات),
					},
					'gigabit' => {
						'' => q(غيغابت),
						'few' => q({0} غيغابت),
					...
					'nautical-mile' => {
						...
						'one' => q({0} ميل بحري),
						'other' => q({0} من الأميال البحرية),
						'two' => q(ميلان بحريان),
						'zero' => q({0} من الأميال البحرية),
					},
					'ohm' => {
						'' => q(أوم),
						'few' => q({0} أوم),
					...
					'ounce-troy' => {
						...
						'other' => q({0} من الأونصات الترويسية),
						'two' => q(أونصتان ترويسيتان),
						'zero' => q({0} من الأونصات الترويسية),
					},
					'parsec' => {
						'' => q(فرسخ فلكي),
						'few' => q({0} فراسخ فلكية),
						...
						'one' => q({0} فرسخ فلكي),
						'other' => q({0} من الفراسخ الفلكية),
						'two' => q(فرسخان فلكيان),
						'zero' => q({0} من الفراسخ الفلكية),
					},
					'per' => {
						'' => q({0} كل {1}),
					},
					...
					'quart' => {
						...
						'many' => q({0} ربع غالون),
						'one' => q({0} ربع غالون),
						'other' => q({0} من أرباع الغالون),
						'two' => q(نصف غالون),
						'zero' => q({0} من أرباع الغالون),
					},
					'radian' => {
						'' => q(راديان),
						'few' => q({0} راديان),
					...
					'tablespoon' => {
						...
						'one' => q({0} ملعقة مائدة),
						'other' => q({0} من ملاعق المائدة),
						'two' => q(ملعقتا مائدة),
						'zero' => q({0} من ملاعق المائدة),
					},
					'teaspoon' => {
						'' => q(ملعقة شاي),
						'few' => q({0} ملاعق شاي),
						'many' => q({0} ملعقة شاي),
						'one' => q({0} ملعقة شاي),
						'other' => q({0} من ملاعق الشاي),
						'two' => q(ملعقتا شاي),
						'zero' => q({0} من ملاعق الشاي),
					},
					'terabit' => {
						'' => q(تيرابت),
						'few' => q({0} تيرابت),
				...
				'short' => {
					...
					'ounce-troy' => {
						...
						'many' => q({0} أونصة ترويسية),
						'one' => q({0} أونصة ترويسية),
						'other' => q({0} أونصات ترويسية),
						'two' => q(أونصتان ترويسيتان),
						'zero' => q({0} أونصات ترويسية),
					},
					'parsec' => {
						'' => q(فرسخ فلكي),
						'few' => q({0} فراسخ فلكية),
