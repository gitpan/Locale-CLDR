...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'g-force' => {
						'' => q(jednotki zemskeho pospěšenja),
					...
					'inch-hg' => {
						'' => q(cóle žiwoslěbroweho stołpika),
					...
					'millimeter-of-mercury' => {
						'' => q(milimetry žiwoslěbroweho stołpika),
