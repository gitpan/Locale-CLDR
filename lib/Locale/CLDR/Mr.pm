	...
	default		=> sub { {
		...
		'GBP' => {
			...
			display_name => {
				...
				'other' => q(ब्रिटिश पाऊंड्स स्टर्लिंग),
			},
		},
		'GEL' => {
			symbol => 'GEL',
		...
		'NIO' => {
			...
			display_name => {
				...
				'other' => q(निकाराग्वेचा कोर्डोबाज),
			},
		},
		'NOK' => {
			symbol => 'NOK',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Apia' => {
			long => {
				'daylight' => q(आपिया सूर्यप्रकाश वेळ),
				'generic' => q(आपिया वेळ),
				'standard' => q(आपिया प्रमाण वेळ),
			},
		},
		'Aqtau' => {
			long => {
