...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(ພາວ​ດ໌ ສະ​ເຕີ​ຣິງ \(ອັງ​ກິດ\)),
				'other' => q(ພາວ​ດ໌ ສະ​ເຕີ​ຣິງ \(ອັງ​ກິດ\)),
			},
		},
		'GEK' => {
			display_name => {
