...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'g-force' => {
						'' => q(jadnotki zemskego póspěšenja),
					...
					'millimeter-of-mercury' => {
						'' => q(milimetry słupika žywego slobra),
