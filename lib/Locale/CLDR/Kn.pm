...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'liter-per-kilometer' => {
						'' => q(ಪ್ರತಿ ಕಿಲೋಮೀಟರ್‌ಗೆ ಲೀಟರ್‌ಗಳು),
						'one' => q({0} ಪ್ರತಿಕಿಲೋಮೀಟರ್‌ಗೆ ಲೀಟರ್‌),
					...
					'meter-per-second' => {
						'' => q(ಪ್ರತಿ ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್‌ಗಳು),
						'one' => q({0} ಪ್ರತಿ ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್),
						'other' => q({0} ಪ್ರತಿ ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್‌ಗಳು),
					},
					'meter-per-second-squared' => {
						'' => q(ಪ್ರತಿ ಎರಡು ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್‌ಗಳು),
						'one' => q({0} ಪ್ರತಿ ಎರಡು ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್‌ಗಳು),
						'other' => q({0} ಪ್ರತಿ ಎರಡು ಸೆಕೆಂಡಿಗೆ ಮೀಟರ್‌‌ಗಳು),
					},
					'metric-ton' => {
						'' => q(ಮೆಟ್ರಿಕ್‌‌ ಟನ್‌ಗಳು),
	...
	default		=> sub { {
		...
		'GBP' => {
			...
			display_name => {
				...
				'other' => q(ಬ್ರಿಟೀಷ್ ಪೌಂಡ್ ಸ್ಟೆರ್ಲಿಂಗ್),
			},
		},
		'GEL' => {
			symbol => 'GEL',
		...
		'UZS' => {
			...
			display_name => {
				...
				'other' => q(ಉಜ್ಬೇಕಿಸ್ತಾನ್ ಸೊಮ್‍ಗಳು),
			},
		},
		'VEF' => {
			symbol => 'VEF',
