...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'ounce-troy' => {
						'' => q(տրոյական ունց),
						'one' => q({0} տրոյական ունց),
						'other' => q({0} տրոյական ունց),
					},
					'parsec' => {
						'' => q(պարսեկ),
						'one' => q({0} պարսեկ),
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Europe_Central' => {
			long => {
				'daylight' => q(Կենտրոնաեվրոպական ամառային ժամանակ),
				'generic' => q(Կենտրոնաեվրոպական ժամանակ),
				'standard' => q(Կենտրոնաեվրոպական ստանդարտ ժամանակ),
			},
		},
		'Europe_Eastern' => {
			long => {
				'daylight' => q(Արևելաեվրոպական ամառային ժամանակ),
				'generic' => q(Արևելաեվրոպական ժամանակ),
				'standard' => q(Արևելաեվրոպական ստանդարտ ժամանակ),
			},
		},
		...
		'Europe_Western' => {
			long => {
				'daylight' => q(Արևմտաեվրոպական ամառային ժամանակ),
				'generic' => q(Արևմտաեվրոպական ժամանակ),
				'standard' => q(Արևմտաեվրոպական ստանդարտ ժամանակ),
			},
		},
		'Falkland' => {
			long => {
