...
has 'curriencies' => (
	...
	default		=> sub { {
		'AED' => {
			display_name => {
				'default' => q(Արաբական Միացյալ Էմիրությունների դիրհամ),
		...
		'ANG' => {
			display_name => {
				'default' => q(Նիդերլանդական Անտիլների գուլդեն),
		...
		'BAM' => {
			display_name => {
				'default' => q(Բոսնիա և Հերցեգովինայի փոխարկելի մարկա),
		...
		'BOB' => {
			display_name => {
				'default' => q(Բոլիվիական բոլիվիանո),
		...
		'BTN' => {
			display_name => {
				'default' => q(Բութանական նգուլտրում),
		...
		'CUC' => {
			display_name => {
				'default' => q(Կուբական փոխարկելի պեսո),
		...
		'FKP' => {
			display_name => {
				'default' => q(Ֆոլկլենդյան կղզիներ ֆունտ),
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(Բրիտանական ֆունտ ստեռլինգ),
		...
		'HNL' => {
			display_name => {
				'default' => q(Հոնդուրասական լեմպրիա),
		...
		'KMF' => {
			display_name => {
				'default' => q(Կոմորյան կղզիների ֆրանկ),
		...
		'KYD' => {
			display_name => {
				'default' => q(Կայմանյան կղզիների դոլար),
		...
		'NIO' => {
			display_name => {
				'default' => q(Նիկարագուական կորդոբա),
		...
		'PGK' => {
			display_name => {
				'default' => q(Պապուա-Նոր Գվինեայի կինա),
		...
		'PYG' => {
			display_name => {
				'default' => q(Պարագվայական գուարանի),
		...
		'SAR' => {
			display_name => {
				'default' => q(Սաուդյան Արաբիայի ռիալ),
		...
		'SBD' => {
			display_name => {
				'default' => q(Սողոմոնյան կղզիների դոլար),
		...
		'SCR' => {
			display_name => {
				'default' => q(Սեյշելյան կղզիների ռուփի),
		...
		'SHP' => {
			display_name => {
				'default' => q(Սուրբ Հեղինեի կղզու ֆունտ),
		...
		'SSP' => {
			display_name => {
				'default' => q(Հարավսուդանական ֆունտ),
		...
		'STD' => {
			display_name => {
				'default' => q(Սան Տոմե և Պրինսիպիի դոբրա),
		...
		'SZL' => {
			display_name => {
				'default' => q(Սվազիլենդական լիլանգենի),
		...
		'TTD' => {
			display_name => {
				'default' => q(Տրինիդադ և Տոբագոյի դոլար),
		...
		'TWD' => {
			symbol => 'NT$',
			display_name => {
				'default' => q(Թայվանական նոր դոլար),
		...
		'VEF' => {
			display_name => {
				'default' => q(Վենեսուելական բոլիվար),
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'default' => q(Աֆրիկական ֆինանսական համայնքի ֆրանկ BEAC),
		...
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(Արևելակարիբյան դոլար),
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q(Աֆրիկական ֆինանսական համայնքի ֆրանկ BCEAO),
		...
		'ZMK' => {
			display_name => {
				'default' => q(Զամբիական կվաչա (1968–2012)),
