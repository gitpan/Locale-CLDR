...
has 'curriencies' => (
	...
	default		=> sub { {
		'ADP' => {
			display_name => {
				'default' => q(ანდორული პესეტა),
			},
		},
		'AED' => {
			display_name => {
				'default' => q(არაბთა გაერთიანებული საამიროების დირჰამი),
		...
		'AFA' => {
			display_name => {
				'default' => q(ავღანი (1927–2002)),
			},
		},
		'AFN' => {
			display_name => {
				'default' => q(ავღანური ავღანი),
		...
		'ANG' => {
			display_name => {
				'default' => q(ნიდერლანდების ანტილების გულდენი),
		...
		'AOK' => {
			display_name => {
				'default' => q(ანგოლური კვანზა (1977–1990)),
			},
		},
		'AON' => {
			display_name => {
				'default' => q(ანგოლური ახალი კვანზა (1990–2000)),
			},
		},
		'AOR' => {
			display_name => {
				'default' => q(ანგოლური მიტოლებული კვანზა (1995–1999)),
			},
		},
		'ARA' => {
			display_name => {
				'default' => q(არგენტინული აუსტრალი),
			},
		},
		'ARP' => {
			display_name => {
				'default' => q(არგენტინული პესო (1983–1985)),
			},
		},
		'ARS' => {
			display_name => {
				'default' => q(არგენტინული პესო),
		...
		'ATS' => {
			display_name => {
				'default' => q(ავსტრიული შილინგი),
			},
		},
		'AUD' => {
			symbol => 'AUD',
			display_name => {
				'default' => q(ავსტრალიური დოლარი),
		...
		'AZM' => {
			display_name => {
				'default' => q(აზერბაიჯანული მანათი (1993–2006)),
			},
		},
		'AZN' => {
			display_name => {
				'default' => q(აზერბაიჯანული მანათი),
		...
		'BAD' => {
			display_name => {
				'default' => q(ბოსნია-ჰერცოგოვინას დინარი),
			},
		},
		'BAM' => {
			display_name => {
				'default' => q(ბოსნია და ჰერცოგოვინას კონვერტირებადი მარკა),
		...
		'BEC' => {
			display_name => {
				'default' => q(ბელგიური ფრანკი (კოვერტირებადი)),
			},
		},
		'BEF' => {
			display_name => {
				'default' => q(ბელგიური ფრანკი),
			},
		},
		'BEL' => {
			display_name => {
				'default' => q(ბელგიური ფრანკი (ფინანსური)),
			},
		},
		'BGL' => {
			display_name => {
				'default' => q(ბულგარული მყარი ლევი),
			},
		},
		'BGN' => {
			display_name => {
				'default' => q(ბულგარული ლევი),
		...
		'BOP' => {
			display_name => {
				'default' => q(ბოლივიური პესო),
			},
		},
		'BRB' => {
			display_name => {
				'default' => q(ბრაზილიური კრუზეირო ნოვო (1967–1986)),
			},
		},
		'BRC' => {
			display_name => {
				'default' => q(ბრაზილიური კრუზადო),
			},
		},
		'BRE' => {
			display_name => {
				'default' => q(ბრაზილიური კრუზეირო (1990–1993)),
			},
		},
		'BRL' => {
			symbol => 'R$',
			display_name => {
				'default' => q(ბრაზილიური რეალი),
		...
		'BRN' => {
			display_name => {
				'default' => q(ბრაზილიური კრუზადო ნოვო),
			},
		},
		'BRR' => {
			display_name => {
				'default' => q(ბრაზილიური კრუზეირო),
			},
		},
		'BSD' => {
			display_name => {
				'default' => q(ბაჰამური დოლარი),
		...
		'BYB' => {
			display_name => {
				'default' => q(ახალი ბელარუსიული რუბლი (1994–1999)),
			},
		},
		'BYR' => {
			display_name => {
				'default' => q(ბელორუსული რუბლი),
		...
		'CSD' => {
			display_name => {
				'default' => q(ძველი სერბიული დინარი),
			},
		},
		'CSK' => {
			display_name => {
				'default' => q(ჩეხოსლოვაკიის მყარი კრონა),
			},
		},
		'CUC' => {
			display_name => {
				'default' => q(კუბური კონვერტირებადი პესო),
		...
		'CYP' => {
			display_name => {
				'default' => q(კვიპროსის გირვანქა),
			},
		},
		'CZK' => {
			display_name => {
				'default' => q(ჩეხური კრონა),
				'one' => q(ჩეხური კრონა),
		...
		'DDM' => {
			display_name => {
				'default' => q(აღმოსავლეთ გერმანული მარკა),
			},
		},
		'DEM' => {
			display_name => {
				'default' => q(გერმანული მარკა),
			},
		},
		'DJF' => {
			display_name => {
				'default' => q(ჯიბუტის ფრანკი),
		...
		'EEK' => {
			display_name => {
				'default' => q(ესტონური კრუნა),
			},
		},
		'EGP' => {
			display_name => {
				'default' => q(ეგვიპტური გირვანქა),
		...
		'ESP' => {
			display_name => {
				'default' => q(ესპანური პესეტა),
			},
		},
		'ETB' => {
			display_name => {
				'default' => q(ეთიოპიური ბირი),
		...
		'FIM' => {
			display_name => {
				'default' => q(ფინური მარკა),
			},
		},
		'FJD' => {
			display_name => {
				'default' => q(ფიჯის დოლარი),
				'one' => q(ფიჯის დოლარი),
		...
		'FKP' => {
			display_name => {
				'default' => q(ფოლკლენდის კუნძულების ფუნტი),
		...
		'FRF' => {
			display_name => {
				'default' => q(ფრანგული ფრანკი),
			},
		},
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(ბრიტანული გირვანქა სტერლინგი),
		...
		'GEK' => {
			display_name => {
				'default' => q(ქართული კუპონი ლარით),
			},
		},
		'GEL' => {
			display_name => {
				'default' => q(ქართული ლარი),
				'one' => q(ქართული ლარი),
		...
		'GRD' => {
			display_name => {
				'default' => q(ბერძნული დრაჰმა),
			},
		},
		'GTQ' => {
			display_name => {
				'default' => q(გვატემალური კეტსალი),
		...
		'GWE' => {
			display_name => {
				'default' => q(პორტუგალიური გინეა ესკუდო),
			},
		},
		'GYD' => {
			display_name => {
				'default' => q(გაიანური დოლარი),
		...
		'HRD' => {
			display_name => {
				'default' => q(ხორვატიული დინარი),
			},
		},
		'HRK' => {
			display_name => {
				'default' => q(ხორვატული კუნა),
		...
		'IEP' => {
			display_name => {
				'default' => q(ირლანდიური გირვანქა),
			},
		},
		'ILS' => {
			symbol => 'ILS',
			display_name => {
				'default' => q(ისრაელის ახალი შეკელი),
		...
		'ITL' => {
			display_name => {
				'default' => q(იტალიური ლირა),
			},
		},
		'JMD' => {
			display_name => {
				'default' => q(იამაიკური დოლარი),
		...
		'KPW' => {
			display_name => {
				'default' => q(ჩრდილოეთ კორეული ვონი),
		...
		'KRW' => {
			symbol => 'KRW',
			display_name => {
				'default' => q(სამხრეთ კორეული ვონი),
		...
		'KYD' => {
			display_name => {
				'default' => q(კაიმანის კუნძულების დოლარი),
		...
		'LTT' => {
			display_name => {
				'default' => q(ლიტვური ტალონი),
			},
		},
		'LUC' => {
			display_name => {
				'default' => q(ლუქსემბურგის კონვერტირებადი ფრანკი),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(ლუქსემბურგის ფრანკი),
			},
		},
		'LUL' => {
			display_name => {
				'default' => q(ლუქსემბურგის ფინანსური ფრანკი),
			},
		},
		'LVL' => {
			display_name => {
				'default' => q(ლატვიური ლატი),
				'one' => q(ლატვიური ლატი),
		...
		'LVR' => {
			display_name => {
				'default' => q(ლატვიური რუბლი),
			},
		},
		'LYD' => {
			display_name => {
				'default' => q(ლიბიური დინარი),
		...
		'MAF' => {
			display_name => {
				'default' => q(მაროკოს ფრანკი),
			},
		},
		'MDL' => {
			display_name => {
				'default' => q(მოლდოვური ლეუ),
				'one' => q(მოლდოვური ლეუ),
		...
		'MGF' => {
			display_name => {
				'default' => q(მადაგასკარის ფრანკი),
			},
		},
		'MKD' => {
			display_name => {
				'default' => q(მაკედონიური დინარი),
		...
		'MLF' => {
			display_name => {
				'default' => q(მალის ფრანკი),
			},
		},
		'MMK' => {
			display_name => {
				'default' => q(მიანმარის კიატი),
		...
		'MTL' => {
			display_name => {
				'default' => q(მალტის ლირა),
			},
		},
		'MTP' => {
			display_name => {
				'default' => q(მალტის გირვანქა),
			},
		},
		'MUR' => {
			display_name => {
				'default' => q(მავრიტანული რუპია),
		...
		'MXP' => {
			display_name => {
				'default' => q(მექსიკური ვერცხლის პესო (1861–1992)),
			},
		},
		'MYR' => {
			display_name => {
				'default' => q(მალაიზიური რინგიტი),
		...
		'MZM' => {
			display_name => {
				'default' => q(ძველი მოზამბიკური მეტიკალი),
			},
		},
		'MZN' => {
			display_name => {
				'default' => q(მოზამბიკური მეტიკალი),
		...
		'NIC' => {
			display_name => {
				'default' => q(ნიკარაგუას კორდობა),
			},
		},
		'NIO' => {
			display_name => {
				'default' => q(ნიკარაგუული კორდობა),
		...
		'NLG' => {
			display_name => {
				'default' => q(ჰოლანდიური გულდენი),
			},
		},
		'NOK' => {
			display_name => {
				'default' => q(ნორვეგიული კრონა),
		...
		'NZD' => {
			symbol => 'NZD',
			display_name => {
				'default' => q(ახალი ზელანდიის დოლარი),
		...
		'PEI' => {
			display_name => {
				'default' => q(პერუს ინტი),
			},
		},
		'PEN' => {
			display_name => {
				'default' => q(პერუს ახალი სოლი),
		...
		'PES' => {
			display_name => {
				'default' => q(პერუს სოლი),
			},
		},
		'PGK' => {
			display_name => {
				'default' => q(პაპუა-ახალი გვინეის კინა),
		...
		'PLZ' => {
			display_name => {
				'default' => q(პოლონური ზლოტი (1950–1995)),
			},
		},
		'PTE' => {
			display_name => {
				'default' => q(პორტუგალიური ესკუდო),
			},
		},
		'PYG' => {
			display_name => {
				'default' => q(პარაგვაული გუარანი),
		...
		'RHD' => {
			display_name => {
				'default' => q(როდეზიული დოლარი),
			},
		},
		'ROL' => {
			display_name => {
				'default' => q(ძველი რუმინული ლეუ),
			},
		},
		'RON' => {
			display_name => {
				'default' => q(რუმინული ლეუ),
				'one' => q(რუმინული ლეუ),
		...
		'RUR' => {
			display_name => {
				'default' => q(რუსული რუბლი (1991–1998)),
			},
		},
		'RWF' => {
			display_name => {
				'default' => q(რუანდული ფრანკი),
		...
		'SAR' => {
			display_name => {
				'default' => q(საუდის არაბეთის რიალი),
		...
		'SBD' => {
			display_name => {
				'default' => q(სოლომონის კუნძულების დოლარი),
		...
		'SDD' => {
			display_name => {
				'default' => q(სუდანის დინარი),
			},
		},
		'SDG' => {
			display_name => {
				'default' => q(სუდანური ფუნტი),
		...
		'SDP' => {
			display_name => {
				'default' => q(სუდანის გირვანქა),
			},
		},
		'SEK' => {
			display_name => {
				'default' => q(შვედური კრონა),
				'one' => q(შვედური კრონა),
		...
		'SHP' => {
			display_name => {
				'default' => q(წმ. ელენეს კუნძულის ფუნტი),
		...
		'SRG' => {
			display_name => {
				'default' => q(სურინამის გულდენი),
			},
		},
		'SSP' => {
			display_name => {
				'default' => q(სამხრეთ სუდანური ფუნტი),
		...
		'STD' => {
			display_name => {
				'default' => q(სან-ტომე და პრინსიპის დობრა),
		...
		'SUR' => {
			display_name => {
				'default' => q(საბჭოთა რუბლი),
			},
		},
		'SYP' => {
			display_name => {
				'default' => q(სირიული ფუნტი),
		...
		'SZL' => {
			display_name => {
				'default' => q(სვაზილენდის ლილანგენი),
		...
		'TJR' => {
			display_name => {
				'default' => q(ტაჯიკური რუბლი),
			},
		},
		'TJS' => {
			display_name => {
				'default' => q(ტაჯიკური სომონი),
		...
		'TMM' => {
			display_name => {
				'default' => q(თურქმენული მანათი),
			},
		},
		'TMT' => {
			display_name => {
				'default' => q(თურქმენეთის მანათი),
		...
		'TRL' => {
			display_name => {
				'default' => q(თურქული ლირა),
			},
		},
		'TRY' => {
			display_name => {
				'default' => q(ახალი თურქული ლირა),
		...
		'TTD' => {
			display_name => {
				'default' => q(ტრინიდად და ტობაგოს დოლარი),
		...
		'TWD' => {
			symbol => 'TWD',
			display_name => {
				'default' => q(ტაივანური ახალი დოლარი),
		...
		'UAK' => {
			display_name => {
				'default' => q(უკრაინული კარბოვანეცი),
			},
		},
		'UGS' => {
			display_name => {
				'default' => q(უგანდური შილინგი (1966–1987)),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(უგანდური შილინგი),
		...
		'USN' => {
			display_name => {
				'default' => q(აშშ დოლარი (შემდეგი დღე)),
			},
		},
		'USS' => {
			display_name => {
				'default' => q(აშშ დოლარი (იგივე დღე)),
			},
		},
		'UYP' => {
			display_name => {
				'default' => q(ურუგვაის პესო (1975–1993)),
			},
		},
		'UYU' => {
			display_name => {
				'default' => q(ურუგვაის პესო),
				'one' => q(ურუგვაის პესო),
		...
		'VEB' => {
			display_name => {
				'default' => q(ვენესუელის ბოლივარი (1871–2008)),
			},
		},
		'VEF' => {
			display_name => {
				'default' => q(ვენესუელის ბოლივარი),
		...
		'XBA' => {
			display_name => {
				'default' => q(ევროპული კომპპოზიტური ერთეული),
			},
		},
		'XBB' => {
			display_name => {
				'default' => q(ევროპული ფულადი ერთეული),
			},
		},
		'XCD' => {
			symbol => 'EC$',
			display_name => {
				'default' => q(აღმოსავლეთ კარიბიული დოლარი),
		...
		'XEU' => {
			display_name => {
				'default' => q(ევროპული სავალუტო ერთეული),
			},
		},
		'XFO' => {
			display_name => {
				'default' => q(ფრანგული ოქროს ფრანკი),
			},
		},
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q((CFA) ფრანკი (BCEAO)),
		...
		'YDD' => {
			display_name => {
				'default' => q(იემენის დინარი),
			},
		},
		'YER' => {
			display_name => {
				'default' => q(იემენის რეალი),
				'one' => q(იემენის რეალი),
		...
		'YUD' => {
			display_name => {
				'default' => q(იუგოსლავიური მყარი დინარი),
			},
		},
		'YUM' => {
			display_name => {
				'default' => q(იუგოსლავიური ახალი დინარი),
			},
		},
		'YUN' => {
			display_name => {
				'default' => q(იუგოსლავიური კონვერტირებადი დინარი),
			},
		},
		'ZAR' => {
			display_name => {
				'default' => q(სამხრეთ აფრიკული რანდი),
		...
		'ZMK' => {
			display_name => {
				'default' => q(ზამბიური კვაჩა (1968–2012)),
		...
		'ZRN' => {
			display_name => {
				'default' => q(ზაირის ახალი ზაირი),
			},
		},
		'ZRZ' => {
			display_name => {
				'default' => q(ზაირის ზაირი),
			},
		},
		'ZWD' => {
			display_name => {
				'default' => q(ზიმბაბვეს დოლარი),
			},
		},
	} },
);
