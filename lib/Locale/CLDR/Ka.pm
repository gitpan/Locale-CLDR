	...
	default		=> sub { {
				'long' => {
					...
					'millimeter-of-mercury' => {
						'' => q(მილიმეტრი ვერცხლისწყლის სვეტისა),
