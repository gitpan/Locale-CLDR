...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AED' => {
			display_name => {
				'default' => q(Дирхам на Обединените арабски емирства),
		...
		'AFA' => {
			display_name => {
				'default' => q(Афганистански афган (1927–2002)),
		...
		'AOK' => {
			display_name => {
				'default' => q(Анголска кванца (1977–1990)),
		...
		'AON' => {
			display_name => {
				'default' => q(Анголска нова кванца (1990–2000)),
		...
		'AOR' => {
			display_name => {
				'default' => q(Анголска нова кванца (1995–1999)),
		...
		'ARP' => {
			display_name => {
				'default' => q(Аржентинско песо (1983–1985)),
		...
		'AZM' => {
			display_name => {
				'default' => q(Азербайджански манат (1993–2006)),
		...
		'AZN' => {
			display_name => {
				'default' => q(Азербайджански манат),
		...
		'BAD' => {
			display_name => {
				'default' => q(Босна и Херцеговина-динар),
		...
		'BAM' => {
			display_name => {
				'default' => q(Босненска конвертируема марка),
		...
		'BEC' => {
			display_name => {
				'default' => q(Белгийски франк (конвертируем)),
		...
		'BEL' => {
			display_name => {
				'default' => q(Белгийски франк (финансов)),
		...
		'BGL' => {
			display_name => {
				'default' => q(Български конвертируем лев (1962–1999)),
		...
		'BOB' => {
			display_name => {
				'default' => q(Боливийско боливиано),
		...
		'BRB' => {
			display_name => {
				'default' => q(Бразилско ново крузейро (1967–1986)),
		...
		'BRC' => {
			display_name => {
				'default' => q(Бразилско крозадо),
			},
		},
		'BRE' => {
			display_name => {
				'default' => q(Бразилско крузейро (1990–1993)),
			},
		},
		'BRL' => {
			symbol => 'BRL',
		...
		'BRN' => {
			display_name => {
				'default' => q(Бразилско ново крозадо),
			},
		},
		'BRR' => {
			display_name => {
				'default' => q(Бразилско крузейро),
			},
		},
		'BSD' => {
			display_name => {
		...
		'BUK' => {
			display_name => {
				'default' => q(Бирмански киат),
			},
		},
		'BWP' => {
			display_name => {
				'default' => q(Ботсуанска пула),
		...
		'BYB' => {
			display_name => {
				'default' => q(Беларуска нова рубла (1994–1999)),
		...
		'CLF' => {
			display_name => {
				'default' => q(Условна разчетна единица на Чили),
			},
		},
		'CLP' => {
			display_name => {
				'default' => q(Чилийско песо),
				'one' => q(чилийско песо),
		...
		'COU' => {
			display_name => {
				'default' => q(Колумбийска единица на реалната стойност),
			},
		},
		'CRC' => {
			display_name => {
		...
		'CSD' => {
			display_name => {
				'default' => q(Стар сръбски динар),
			},
		},
		'CSK' => {
			display_name => {
				'default' => q(Чехословашка конвертируема крона),
		...
		'CUC' => {
			display_name => {
				'default' => q(Кубинско конвертируемо песо),
		...
		'CVE' => {
			display_name => {
				'default' => q(Ескудо на Кабо Верде),
		...
		'DDM' => {
			display_name => {
				'default' => q(Източногерманска марка),
			},
		},
		'DEM' => {
			display_name => {
				'default' => q(Германска марка),
		...
		'ECV' => {
			display_name => {
				'default' => q(Еквадорска банкова единица),
			},
		},
		'EEK' => {
			display_name => {
				'default' => q(Естонска крона),
		...
		'GEK' => {
			display_name => {
				'default' => q(Грузински купон),
			},
		},
		'GEL' => {
			display_name => {
				'default' => q(Грузински лари),
		...
		'GHC' => {
			display_name => {
				'default' => q(Ганайско седи (1979–2007)),
		...
		'GNS' => {
			display_name => {
				'default' => q(Гвинейска сили),
			},
		},
		'GQE' => {
			display_name => {
				'default' => q(Екваториално гвинейско еквеле),
			},
		},
		'GRD' => {
			display_name => {
				'default' => q(Гръцка драхма),
				'one' => q(гръцка драхма),
		...
		'GWE' => {
			display_name => {
				'default' => q(Ескудо от Португалска Гвинея),
			},
		},
		'GWP' => {
			display_name => {
				'default' => q(Гвинея-Бисау песо),
			},
		},
		'GYD' => {
			display_name => {
				'default' => q(Гаянски долар),
				'one' => q(гаянски долар),
		...
		'LTT' => {
			display_name => {
				'default' => q(Литовски талон),
			},
		},
		'LUF' => {
			display_name => {
				'default' => q(Люксембургски франк),
		...
		'MGF' => {
			display_name => {
				'default' => q(Малгашки франк - Мадагаскар),
		...
		'MLF' => {
			display_name => {
				'default' => q(Малийски франк),
			},
		},
		'MMK' => {
			display_name => {
				'default' => q(Мианмарски кият),
		...
		'MXP' => {
			display_name => {
				'default' => q(Мексиканско сребърно песо (1861–1992)),
		...
		'MXV' => {
			display_name => {
				'default' => q(Мексиканска конвертируема единица (UDI)),
			},
		},
		'MYR' => {
			display_name => {
				'default' => q(Малайзийски рингит),
		...
		'MZM' => {
			display_name => {
				'default' => q(Мозамбикски метикал (1980–2006)),
		...
		'NIC' => {
			display_name => {
				'default' => q(Никарагуанска кордоба (1988–1991)),
		...
		'NIO' => {
			display_name => {
				'default' => q(Никарагуанска кордоба),
		...
		'PEI' => {
			display_name => {
				'default' => q(Перуанско инти),
			},
		},
		'PEN' => {
			display_name => {
				'default' => q(Перуански нов сол),
		...
		'PGK' => {
			display_name => {
				'default' => q(Папуа-новогвинейска кина),
		...
		'PLZ' => {
			display_name => {
				'default' => q(Полска злота (1950–1995)),
		...
		'RHD' => {
			display_name => {
				'default' => q(Родезийски долар),
			},
		},
		'ROL' => {
			display_name => {
				'default' => q(Стара румънска лея),
		...
		'RUR' => {
			display_name => {
				'default' => q(Руска рубла (1991–1998)),
		...
		'SAR' => {
			display_name => {
				'default' => q(Саудитскоарабски риал),
		...
		'SBD' => {
			display_name => {
				'default' => q(Долар на Соломоновите острови),
		...
		'STD' => {
			display_name => {
				'default' => q(Добра на Сао Томе и Принсипи),
		...
		'SZL' => {
			display_name => {
				'default' => q(Свазилендски лилангени),
		...
		'TJR' => {
			display_name => {
				'default' => q(Таджикистанска рубла),
		...
		'TJS' => {
			display_name => {
				'default' => q(Таджикистански сомони),
		...
		'TTD' => {
			display_name => {
				'default' => q(Долар на Тринидад и Тобаго),
		...
		'UAK' => {
			display_name => {
				'default' => q(Украински карбованец),
		...
		'UGS' => {
			display_name => {
				'default' => q(Угандийски шилинг (1966–1987)),
		...
		'UYI' => {
			display_name => {
				'default' => q(Уругвайско песо (индекс на инфлацията)),
			},
		},
		'UYP' => {
			display_name => {
				'default' => q(Уругвайско песо (1975–1993)),
		...
		'VEB' => {
			display_name => {
				'default' => q(Венецуелски боливар (1871–2008)),
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'default' => q(Централноафрикански CFA франк),
		...
		'XBA' => {
			display_name => {
				'default' => q(Европейска съставна единица),
			},
		},
		'XBB' => {
			display_name => {
				'default' => q(Европейска валутна единица),
			},
		},
		'XBC' => {
			display_name => {
				'default' => q(Европейска единица по сметка (XBC)),
			},
		},
		'XBD' => {
			display_name => {
				'default' => q(Европейска единица по сметка (XBD)),
			},
		},
		'XCD' => {
			symbol => 'XCD',
			display_name => {
				'default' => q(Източнокарибски долар),
		...
		'XDR' => {
			display_name => {
				'default' => q(Специални права на тираж),
			},
		},
		'XEU' => {
			display_name => {
				'default' => q(Еку на ЕИО),
			},
		},
		'XFO' => {
			display_name => {
				'default' => q(Френски златен франк),
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'default' => q(Западноафрикански CFA франк),
		...
		'XPF' => {
			symbol => 'CFPF',
			display_name => {
				'default' => q(Френскополинезийски франк),
		...
		'XTS' => {
			display_name => {
				'default' => q(Код резервиран за целите на тестване),
			},
		},
		'XXX' => {
			display_name => {
				'default' => q(Непозната или невалидна валута),
		...
		'YUD' => {
			display_name => {
				'default' => q(Югославски твърд динар),
			},
		},
		'YUM' => {
			display_name => {
				'default' => q(Югославски динар),
		...
		'YUN' => {
			display_name => {
				'default' => q(Югославски конвертируем динар),
		...
		'ZAL' => {
			display_name => {
				'default' => q(Южноафрикански ранд (финансов)),
		...
		'ZMK' => {
			display_name => {
				'default' => q(Замбийска квача (1968–2012)),
		...
		'ZWL' => {
			display_name => {
				'default' => q(Зимбабвийски долар (2009)),
