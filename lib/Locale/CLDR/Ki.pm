...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			display_name => {
				'default' => q(Mbauini cia Ngeretha),
			},
		},
		'GHC' => {
			display_name => {
		...
		'TZS' => {
			display_name => {
				'default' => q(ciringi cia Tanizania),
			},
		},
		'UGX' => {
			display_name => {
				'default' => q(ciringi cia Ũganda),
			},
		},
		'USD' => {
			display_name => {
				'default' => q(Ndora cia Amerika),
			},
		},
		'XAF' => {
			display_name => {
