...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(વધુ પૂર્વીય યુરોપીયન સમય),
			},
		},
		'Europe_Western' => {
			long => {
