...
has 'display_name_type' => (
	...
	default		=> sub {
		{
			'calendar' => {
 				'buddhist' => q{ប្រតិទិន​ពុទ្ធសាសនិក},
 				'chinese' => q{ប្រតិទិន​ចិន},
 				'dangi' => q{ប្រតិទិន​ dangi},
 				'ethiopic' => q{ប្រតិទិន​អេត្យូពី},
 				'gregorian' => q{ប្រតិទិន​ហ្សកហ្ស៊ី},
 				'hebrew' => q{ប្រតិទិន​ហេប្រិ},
 				'islamic' => q{ប្រតិទិន​អ៊ិស្លាម},
 				'iso8601' => q{ប្រតិទិន ISO-8601},
 				'japanese' => q{ប្រតិទិន​ជប៉ុន},
 				'persian' => q{ប្រតិទិន Persian},
 				'roc' => q{ប្រតិទិន Minguo},
 			},
 			'collation' => {
...
has 'characters' => (
	...
	sub {
		...
		return {
			...
			main => qr{(?^u:[៌ ៎ ៏ ៑ ័ ៈ ់ ៉ ៊ ៍ ក ខ គ ឃ ង ច ឆ ជ ឈ ញ ដ ឋ ឌ ឍ ណ ត ថ ទ ធ ន ប ផ ព ភ ម យ រ ឫ ឬ ល ឭ ឮ វ ស ហ ឡ អ {អា} ឥ ឦ ឧ {ឧក} ឩ ឪ ឯ ឰ ឱ ឲ ឳ ា ិ ី ឹ ឺ ុ ូ ួ ើ ឿ ៀ េ ែ ៃ ោ ៅ ំ ះ ្])},
			punctuation => qr{(?^u:[\- , ៖ ! ? . ។ ៕ ‘ ’ " “ ” ( ) \[ \] \{ \} ៙ ៚])},
		};
	},
EOT
...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'meter-per-second' => {
						'' => q(ម៉ែត្រ​ក្នុង​មួយ​វិនាទី),
						'other' => q({0} ម៉ែត្រ​ក្នុង​មួយ​វិនាទី),
					},
					'meter-per-second-squared' => {
						'' => q(ម៉ែត្រ​ក្នុង​មួយ​វិនាទី​ការ៉េ),
					...
					'mile-per-gallon' => {
						'' => q(ម៉ាយល៍​ក្នុង​មួយ​ហ្គាឡុង),
						'other' => q({0} ម៉ាយល៍​ក្នុង​មួយ​ហ្គាឡុង),
					},
					'mile-per-hour' => {
						'' => q(ម៉ាយល៍​ក្នុង​មួយ​ម៉ោង),
					...
					'pound-per-square-inch' => {
						'' => q(ផោន​ក្នុង​មួយ​អ៊ិន្ឈ៍​ការ៉េ),
						'other' => q({0} ផោន​ក្នុង​មួយ​អ៊ិន្ឈ៍​ការ៉េ),
					},
					'quart' => {
						'' => q(ក្វាត),
						'other' => q({0} ក្វាត),
				...
				'short' => {
					...
					'meter-per-second' => {
						'' => q(ម៉ែត្រ​/​វិនាទី),
						'other' => q({0} ម៉ែត្រ​/​វិនាទី),
					},
					'meter-per-second-squared' => {
						'' => q(ម៉ែត្រ​/​វិនាទី​ការ៉េ),
						'other' => q({0} m/s²),
					},
					'metric-ton' => {
						'' => q(t),
	...
	default		=> sub { {
		'AED' => {
			...
			display_name => {
				...
				'other' => q(ឌៀរហាំ អេមីរ៉ាតអារ៉ាប់រួម),
			},
		},
		'AFN' => {
			symbol => 'AFN',
		...
		'CUC' => {
			...
			display_name => {
				...
				'other' => q(ប៉ឺហ្សូ​អាច​បម្លែង​បាន​គុយបា),
			},
		},
		'CUP' => {
			symbol => 'CUP',
		...
		'GBP' => {
			...
			display_name => {
				...
				'other' => q(ផោនស្ទែរលិញ​ចក្រភព​អង់គ្លេស),
			},
		},
		'GEL' => {
			symbol => 'GEL',
		...
		'IDR' => {
			symbol => 'IDR',
			display_name => {
				'currency' => q(រ៉ូពីឥណ្ឌូណេស៊ី),
				'other' => q(រ៉ូពីឥណ្ឌូនេស៊ី),
			},
		},
		'ILS' => {
			symbol => '₪',
		...
		'UYU' => {
			symbol => 'UYU',
			display_name => {
				'currency' => q(ប៉ឺហ្សូអ៊ុយរូហ្គាយ),
				'other' => q(ប៉ឺហ្សូអ៊ុយរូហ្គាយ),
			},
		},
		'UZS' => {
			symbol => 'UZS',
		...
		'ZAR' => {
			...
			display_name => {
				...
				'other' => q(រ៉ង់​អាព្រិក​ខាង​ត្បូង),
			},
		},
		'ZMK' => {
			display_name => {
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Chile' => {
			long => {
				'daylight' => q(ម៉ោង​រដូវ​ក្ដៅ​នៅ​ស៊ីលី),
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(ម៉ោង​នៅ​អឺរ៉ុប​ភាគ​ខាង​កើត​ឆ្ងាយ),
			},
		},
		'Europe_Western' => {
			long => {
		...
		'Greenland_Eastern' => {
			long => {
				'daylight' => q(ម៉ោង​រដូវ​ក្ដៅ​នៅ​ហ្គ្រោអង់ឡង់​​ខាង​កើត),
				'generic' => q(ម៉ោង​​នៅ​ហ្គ្រោអង់ឡង់​ខាង​កើត),
				'standard' => q(ម៉ោង​​​ស្តង់ដារ​នៅ​ហ្គ្រោអង់ឡង់​​​ខាង​កើត),
			},
		},
		'Greenland_Western' => {
			long => {
				'daylight' => q(ម៉ោង​រដូវ​ក្ដៅ​​នៅ​ហ្គ្រោអង់ឡង់​ខាង​​លិច),
