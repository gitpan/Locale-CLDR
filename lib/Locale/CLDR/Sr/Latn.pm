...
#	on Thu  2 Oct  1:47:24 pm GMT
# XML file generated 2014-08-14 23:26:58 -0500 (Thu, 14 Aug 2014)
	...
	default		=> sub { {
		...
		'KZT' => {
			...
			display_name => {
				...
				'few' => q(kazahstanske tenge),
				'one' => q(kazahstanski tenge),
				'other' => q(kazahstanskih tengi),
			},
		},
		'LAK' => {
			symbol => 'LAK',
