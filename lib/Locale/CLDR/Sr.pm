...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'AED' => {
			display_name => {
				'default' => q(Уједињени арапски емирати дирхам),
				'few' => q(УАЕ дирама),
				'one' => q(УАЕ дирам),
				'other' => q(УАЕ дирама),
			},
		...
		'AFA' => {
			display_name => {
				'default' => q(Авганистански авгани (1927–2002)),
		...
		'AFN' => {
			display_name => {
				'default' => q(Авганистански авгани),
		...
		'ANG' => {
			display_name => {
				'default' => q(Холандски антили гилдер),
		...
		'AOK' => {
			display_name => {
				'default' => q(Анголијска кванза (1977–1990)),
		...
		'AON' => {
			display_name => {
				'default' => q(Анголијска нова кванза (1990–2000)),
		...
		'AOR' => {
			display_name => {
				'default' => q(Анголијска кванза реађустадо (1995–1999)),
		...
		'ARL' => {
			display_name => {
				'default' => q(Аргентински пезос леј),
		...
		'ARM' => {
			display_name => {
				'default' => q(Аргентински пезос монедо национал),
		...
		'ARP' => {
			display_name => {
				'default' => q(Аргентински пезо (1983–1985)),
		...
		'AZM' => {
			display_name => {
				'default' => q(Азербејџански манат (1993–2006)),
		...
		'BAD' => {
			display_name => {
				'default' => q(Босанско-Херцеговачки динар),
		...
		'BAN' => {
			display_name => {
				'default' => q(Босанско-херцеговачки нови динар),
		...
		'BEC' => {
			display_name => {
				'default' => q(Белгијски франак (конвертибилни)),
		...
		'BEL' => {
			display_name => {
				'default' => q(Белгијски франак (финансијски)),
		...
		'BGM' => {
			display_name => {
				'default' => q(Бугарски социјалистички лев),
		...
		'BOB' => {
			display_name => {
				'default' => q(Боливијски Боливиано),
		...
		'BOL' => {
			display_name => {
				'default' => q(Стари боливијски боливијано),
		...
		'BRB' => {
			display_name => {
				'default' => q(Бразилски нови крузеиро (1967–1986)),
		...
		'BRE' => {
			display_name => {
				'default' => q(Бразилски крузеиро (1990–1993)),
		...
		'BRN' => {
			display_name => {
				'default' => q(Бразилијски нови крузадо),
		...
		'BRZ' => {
			display_name => {
				'default' => q(Стари бразилски крузеиро),
		...
		'BYB' => {
			display_name => {
				'default' => q(Белоруска нова рубља (1994–1999)),
		...
		'CLF' => {
			display_name => {
				'default' => q(Чилеовски унидадес се фоменто),
		...
		'CNX' => {
			display_name => {
				'default' => q(Долар кинеске народне банке),
		...
		'CNY' => {
			symbol => 'CN¥',
			display_name => {
				'default' => q(Кинески јуан ренминби),
				'few' => q(кинеска јуан),
				'one' => q(кинески јуан),
		...
		'COU' => {
			display_name => {
				'default' => q(Унидад де валоршки реал),
		...
		'CSK' => {
			display_name => {
				'default' => q(Чехословачка тврда круна),
		...
		'CUC' => {
			display_name => {
				'default' => q(Кубански конвертибилни песо),
		...
		'DDM' => {
			display_name => {
				'default' => q(Источно-немачка марка),
		...
		'ECV' => {
			display_name => {
				'default' => q(Еквадорски унидад де валор константе),
		...
		'ESA' => {
			display_name => {
				'default' => q(Шпанска пезета (рачун)),
		...
		'ESB' => {
			display_name => {
				'default' => q(Шпанска пезета (конвертибилнирачун)),
		...
		'FKP' => {
			display_name => {
				'default' => q(Фокландска острва фунта),
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'default' => q(Британска фунта стерлинга),
		...
		'GEK' => {
			display_name => {
				'default' => q(Грузијски купон ларит),
		...
		'GHC' => {
			display_name => {
				'default' => q(Гански цеди (1979–2007)),
		...
		'GQE' => {
			display_name => {
				'default' => q(Екваторијално-гвинејски еквеле),
		...
		'GWE' => {
			display_name => {
				'default' => q(Португалска гвинеја ескудо),
		...
		'ILR' => {
			display_name => {
				'default' => q(Стари израелски шекели),
		...
		'ILS' => {
			symbol => '₪',
			display_name => {
				'default' => q(Израелски нови шекел),
		...
		'ISJ' => {
			display_name => {
				'default' => q(Стара исландска круна),
		...
		'KRO' => {
			display_name => {
				'default' => q(Стари јужнокорејски вон),
		...
		'KYD' => {
			display_name => {
				'default' => q(Кајманска острва долар),
		...
		'LUC' => {
			display_name => {
				'default' => q(Луксембуршки конвертибилни франак),
		...
		'LUL' => {
			display_name => {
				'default' => q(Луксембуршки финансијски франак),
		...
		'MCF' => {
			display_name => {
				'default' => q(Монегаскански франак),
		...
		'MKN' => {
			display_name => {
				'default' => q(Стари македонски денар),
		...
		'MXP' => {
			display_name => {
				'default' => q(Мексички сребрни пезо (1861–1992)),
		...
		'MXV' => {
			display_name => {
				'default' => q(Мексички унидад де инверсион (UDI)),
		...
		'MZM' => {
			display_name => {
				'default' => q(Стари мозамбијски метикал),
		...
		'NIC' => {
			display_name => {
				'default' => q(Никарагванска кордоба),
		...
		'NIO' => {
			display_name => {
				'default' => q(Никарагванска златна кордоба),
		...
		'PLZ' => {
			display_name => {
				'default' => q(Пољски злоти (1950–1995)),
		...
		'RON' => {
			display_name => {
				'default' => q(Румунски леј (1952–2006)),
		...
		'RUR' => {
			display_name => {
				'default' => q(Руска рубља (1991–1998)),
		...
		'SBD' => {
			display_name => {
				'default' => q(Соломонско-острвски долар),
		...
		'SDD' => {
			display_name => {
				'default' => q(Стари судански динар),
		...
		'SDP' => {
			display_name => {
				'default' => q(Стара суданска фунта),
		...
		'SLL' => {
			display_name => {
				'default' => q(Сијера-леоншки леоне),
		...
		'STD' => {
			display_name => {
				'default' => q(Сао Томе и Принципе добра),
		...
		'TMM' => {
			display_name => {
				'default' => q(Туркменистански манат (1993–2009)),
		...
		'TMT' => {
			display_name => {
				'default' => q(Туркменистански манат),
		...
		'TRL' => {
			display_name => {
				'default' => q(Турска лира (1922–2005)),
		...
		'TTD' => {
			display_name => {
				'default' => q(Тринидад тобагошки долар),
		...
		'TWD' => {
			symbol => 'NT$',
			display_name => {
				'default' => q(Нови тајвански долар),
		...
		'UAK' => {
			display_name => {
				'default' => q(Украјински карбованети),
		...
		'UGS' => {
			display_name => {
				'default' => q(Угандски шилинг (1966–1987)),
		...
		'USN' => {
			display_name => {
				'default' => q(САД долар (следећи дан)),
		...
		'UYI' => {
			display_name => {
				'default' => q(Уругвајски пезо ен унидадес индексадас),
		...
		'UYP' => {
			display_name => {
				'default' => q(Уругвајски пезо (1975–1993)),
		...
		'VEB' => {
			display_name => {
				'default' => q(Венецуелански боливар (1871–2008)),
		...
		'VEF' => {
			display_name => {
				'default' => q(Венецуелански боливар),
		...
		'VNN' => {
			display_name => {
				'default' => q(Вијетнамски донг (1978–1985)),
		...
		'XBA' => {
			display_name => {
				'default' => q(Европска композитна јединица),
		...
		'XBB' => {
			display_name => {
				'default' => q(Европска новчана јединица),
		...
		'XBC' => {
			display_name => {
				'default' => q(Европска јединица рачуна (XBC)),
		...
		'XBD' => {
			display_name => {
				'default' => q(Европска јединица рачуна (XBD)),
		...
		'XCD' => {
			display_name => {
				'default' => q(Источно-карипски долар),
		...
		'XDR' => {
			display_name => {
				'default' => q(Посебна цртаћа права),
		...
		'XEU' => {
			display_name => {
				'default' => q(Европска валутна јединица),
		...
		'XFO' => {
			display_name => {
				'default' => q(Француски златни франак),
		...
		'XFU' => {
			display_name => {
				'default' => q(Француски UIC-франак),
		...
		'XTS' => {
			display_name => {
				'default' => q(Код тестиране валуте),
		...
		'XXX' => {
			display_name => {
				'default' => q(Непозната или неважећа валута),
		...
		'YUD' => {
			display_name => {
				'default' => q(Југословенски тврди динар),
		...
		'YUM' => {
			display_name => {
				'default' => q(Југословенски нови динар),
		...
		'YUN' => {
			display_name => {
				'default' => q(Југословенски конвертибилни динар),
		...
		'YUR' => {
			display_name => {
				'default' => q(Југословенски реформирани динар),
		...
		'ZAL' => {
			display_name => {
				'default' => q(Јужно-афрички ранд (финансијски)),
		...
		'ZMK' => {
			display_name => {
				'default' => q(Замбијска квача (1968–2012)),
		...
		'ZWD' => {
			display_name => {
				'default' => q(Зимбабвеански долар (1980–2008)),
		...
		'ZWL' => {
			display_name => {
				'default' => q(Зимбабвеански долар (2009)),
		...
		'ZWR' => {
			display_name => {
				'default' => q(Зимбабвеански долар (2008)),
